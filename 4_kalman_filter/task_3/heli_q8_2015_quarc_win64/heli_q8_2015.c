...
void heli_q8_2015_output0(void)        /* Sample time: [0.0s, 0.0s] */
{
   ...
   *  Gain: '<S4>/Gain'
   */
  tmp[0] = heli_q8_2015_B.imuoffset1;
  ...
  if (rtmIsMajorTimeStep(heli_q8_2015_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[11] = heli_q8_2015_B.Switch1;
    rtb_TmpSignalConversionAtToFile[12] = heli_q8_2015_B.euler_rates[0];
    rtb_TmpSignalConversionAtToFile[13] = heli_q8_2015_B.Sum1_p;
    ...
    rtb_TmpSignalConversionAtToFile[14] = heli_q8_2015_B.euler_rates[1];
    ...
    rtb_TmpSignalConversionAtToFile[15] = heli_q8_2015_B.euler_rates[2];
  ...
  /* Sum: '<S17>/Sum1' */
  heli_q8_2015_B.Sum1_h = heli_q8_2015_B.imuoffset1 - heli_q8_2015_B.Sum[0];
  for (i = 0; i < 5; i++) {
  ...
  for (i = 0; i < 5; i++) {
    ...
    heli_q8_2015_B.Sum1_e[i] = (heli_q8_2015_P.B[i + 5] * heli_q8_2015_B.Sum_j[1]
      + heli_q8_2015_P.B[i] * rtb_Sqrt) + (tmp_4[i] + tmp_5[i]);
  }
}
...
RT_MODEL_heli_q8_2015_T *heli_q8_2015(void)
{
  ...
  /* External mode info */
  heli_q8_2015_M->Sizes.checksums[0] = (112945668U);
  heli_q8_2015_M->Sizes.checksums[1] = (1429609917U);
  heli_q8_2015_M->Sizes.checksums[2] = (4093376623U);
  heli_q8_2015_M->Sizes.checksums[3] = (3138438384U);
  ...
  heli_q8_2015_M->Sizes.numBlocks = (121);/* Number of blocks */
  heli_q8_2015_M->Sizes.numBlockIO = (35);/* Number of block outputs */
