 ...
 * C source code generated on : Sat Oct 24 23:25:33 2020
 *
...
#ifndef RTW_HEADER_heli_q8_2015_h_
#define RTW_HEADER_heli_q8_2015_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_q8_2015_COMMON_INCLUDES_
# define heli_q8_2015_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_2015_COMMON_INCLUDES_ */

#include "heli_q8_2015_types.h"
...
#define heli_q8_2015_rtModel           RT_MODEL_heli_q8_2015_T
...
typedef struct {
  ...
  real_T PulseGenerator;               /* '<S19>/Pulse Generator' */
  real_T PulseGenerator1;              /* '<S19>/Pulse Generator1' */
  real_T Sum[2];                       /* '<S16>/Sum' */
  real_T Integrator[5];                /* '<S5>/Integrator' */
  real_T imuoffset1;                   /* '<S5>/imu offset1' */
  real_T imuoffset;                    /* '<S5>/imu offset' */
  real_T Integrator1;                  /* '<S17>/Integrator1' */
  real_T Integrator_l;                 /* '<S17>/Integrator' */
  ...
  real_T Gain4[5];                     /* '<S5>/Gain4' */
  real_T Sum1_e[5];                    /* '<S5>/Sum1' */
  real_T euler_rates[3];               /* '<S7>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
...
typedef struct {
  ...
  struct {
    void *FilePtr;
  } ToFile_PWORK;                      /* '<S15>/To File' */

  struct {
    void *LoggedData[3];
  } Scopeelevation_PWORK;              /* '<S18>/Scope elevation' */

  struct {
    void *LoggedData[4];
  } Scopeelevationrate_PWORK;          /* '<S18>/Scope elevation rate' */

  struct {
    void *LoggedData;
  } Scopegamma_PWORK;                  /* '<S18>/Scope gamma' */

  struct {
    void *LoggedData[4];
  } Scopepitch_PWORK;                  /* '<S18>/Scope pitch' */

  struct {
    void *LoggedData[3];
  } Scopepitchrate_PWORK;              /* '<S18>/Scope pitch rate' */

  struct {
    void *LoggedData[3];
  } Scopetravelrate_PWORK;             /* '<S18>/Scope travel rate' */

  struct {
    void *LoggedData;
  } Scopezeta_PWORK;                   /* '<S18>/Scope zeta' */
  ...
  int32_T clockTickCounter_e;          /* '<S19>/Pulse Generator1' */
  uint32_T HILInitialize_POSortedChans[8];/* '<Root>/HIL Initialize' */
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK;                      /* '<S15>/To File' */
...
typedef struct {
  ...
  real_T Integrator_CSTATE_m;          /* '<S17>/Integrator' */
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_m;       /* '<S17>/Integrator' */
...
#define rtB                            heli_q8_2015_B
#define BlockIO                        B_heli_q8_2015_T
#define rtX                            heli_q8_2015_X
#define ContinuousStates               X_heli_q8_2015_T
#define rtXdot                         heli_q8_2015_XDot
#define StateDerivatives               XDot_heli_q8_2015_T
#define tXdis                          heli_q8_2015_XDis
#define StateDisabled                  XDis_heli_q8_2015_T
#define rtP                            heli_q8_2015_P
#define Parameters                     P_heli_q8_2015_T
#define rtDWork                        heli_q8_2015_DW
#define D_Work                         DW_heli_q8_2015_T

/* Parameters (auto storage) */
struct P_heli_q8_2015_T_ {
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T imuoffset1_Bias;              /* Expression: 0.02
                                        * Referenced by: '<S5>/imu offset1'
                                        */
  real_T imuoffset_Bias;               /* Expression: 0.04
...
extern P_heli_q8_2015_T heli_q8_2015_P;

/* Block signals (auto storage) */
extern B_heli_q8_2015_T heli_q8_2015_B;

/* Continuous states (auto storage) */
extern X_heli_q8_2015_T heli_q8_2015_X;

/* Block states (auto storage) */
extern DW_heli_q8_2015_T heli_q8_2015_DW;
...
extern void heli_q8_2015_initialize(void);
extern void heli_q8_2015_output0(void);
extern void heli_q8_2015_update0(void);
extern void heli_q8_2015_output(int_T tid);
extern void heli_q8_2015_update(int_T tid);
extern void heli_q8_2015_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_2015_rtModel *heli_q8_2015(void);
...
extern RT_MODEL_heli_q8_2015_T *const heli_q8_2015_M;
 ...
 *
 * '<Root>' : 'heli_q8_2015'
 * '<S1>'   : 'heli_q8_2015/Conversion'
 * '<S2>'   : 'heli_q8_2015/Heli 3D'
 * '<S3>'   : 'heli_q8_2015/Joystick'
 * '<S4>'   : 'heli_q8_2015/LQR with integrator'
 * '<S5>'   : 'heli_q8_2015/state estimator'
 * '<S6>'   : 'heli_q8_2015/Heli 3D/IMU1'
 * '<S7>'   : 'heli_q8_2015/Heli 3D/Measurement'
 * '<S8>'   : 'heli_q8_2015/Heli 3D/Motor driver'
 * '<S9>'   : 'heli_q8_2015/Heli 3D/Subsystem'
 * '<S10>'  : 'heli_q8_2015/Heli 3D/Measurement/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S11>'  : 'heli_q8_2015/Heli 3D/Measurement/convert to x'
 * '<S12>'  : 'heli_q8_2015/Heli 3D/Measurement/imu angles'
 * '<S13>'  : 'heli_q8_2015/Heli 3D/Measurement/imu angles/elevation_eq'
 * '<S14>'  : 'heli_q8_2015/Heli 3D/Measurement/imu angles/pitch_eq'
 * '<S15>'  : 'heli_q8_2015/LQR with integrator/Subsystem'
 * '<S16>'  : 'heli_q8_2015/LQR with integrator/Test'
 * '<S17>'  : 'heli_q8_2015/LQR with integrator/integrator'
 * '<S18>'  : 'heli_q8_2015/LQR with integrator/Subsystem/scope'
 * '<S19>'  : 'heli_q8_2015/LQR with integrator/Test/Refernce test'
 */
#endif                                 /* RTW_HEADER_heli_q8_2015_h_ */
