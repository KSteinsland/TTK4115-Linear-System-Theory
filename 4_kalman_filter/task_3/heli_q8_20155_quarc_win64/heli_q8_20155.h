...
typedef struct {
  ...
  real_T PulseGenerator;               /* '<S22>/Pulse Generator' */
  ...
  real_T Integrator1;                  /* '<S20>/Integrator1' */
  real_T Integrator;                   /* '<S20>/Integrator' */
  real_T Sum_jz[2];                    /* '<S5>/Sum' */
  real_T Bias;                         /* '<S5>/Bias' */
  real_T Switch[10];                   /* '<S6>/Switch' */
  real_T Switch1;                      /* '<S14>/Switch1' */
  real_T Switch1_o;                    /* '<S13>/Switch1' */
  real_T Sum1_j[6];                    /* '<S7>/Sum1' */
...
typedef struct {
  real_T UnitDelay_DSTATE[6];          /* '<S16>/Unit Delay' */
  real_T UnitDelay1_DSTATE[36];        /* '<S16>/Unit Delay1' */
  real_T UnitDelay2_DSTATE[2];         /* '<S16>/Unit Delay2' */
  ...
  struct {
    void *LoggedData;
  } elevationimu_PWORK;                /* '<S12>/elevation imu' */

  struct {
    void *LoggedData;
  } pitchimu_PWORK;                    /* '<S12>/pitch imu' */
  ...
  struct {
    void *FilePtr;
  } ToFile_PWORK_e;                    /* '<S18>/To File' */

  struct {
    void *LoggedData[3];
  } Scopeelevation_PWORK;              /* '<S21>/Scope elevation' */

  struct {
    void *LoggedData[4];
  } Scopeelevationrate_PWORK;          /* '<S21>/Scope elevation rate' */

  struct {
    void *LoggedData[4];
  } Scopepitch_PWORK;                  /* '<S21>/Scope pitch' */

  struct {
    void *LoggedData[3];
  } Scopepitchrate_PWORK;              /* '<S21>/Scope pitch rate' */

  struct {
    void *LoggedData[3];
  } Scopetravel_PWORK;                 /* '<S21>/Scope travel' */

  struct {
    void *LoggedData[3];
  } Scopetravelrate_PWORK;             /* '<S21>/Scope travel rate' */

  struct {
    void *LoggedData;
  } ScopeV_d_PWORK;                    /* '<S21>/Scope V_d' */

  struct {
    void *LoggedData;
  } ScopeV_s_PWORK;                    /* '<S21>/Scope V_s' */

  struct {
    void *LoggedData;
  } Scopegamma_PWORK;                  /* '<S21>/Scope gamma' */

  struct {
    void *LoggedData;
  } Scopezeta_PWORK;                   /* '<S21>/Scope zeta' */
  ...
  int32_T clockTickCounter;            /* '<S22>/Pulse Generator' */
  int32_T clockTickCounter_a;          /* '<S22>/Pulse Generator1' */
 ...
 * '<S10>'  : 'heli_q8_20155/Heli 3D/Measurement/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S11>'  : 'heli_q8_20155/Heli 3D/Measurement/convert to x'
 * '<S12>'  : 'heli_q8_20155/Heli 3D/Measurement/imu angles'
 * '<S13>'  : 'heli_q8_20155/Heli 3D/Measurement/imu angles/elevation_eq'
 * '<S14>'  : 'heli_q8_20155/Heli 3D/Measurement/imu angles/pitch_eq'
 * '<S15>'  : 'heli_q8_20155/Kalman filter/Correction function'
 * '<S16>'  : 'heli_q8_20155/Kalman filter/Prediction'
 * '<S17>'  : 'heli_q8_20155/Kalman filter/Prediction/Prediction function'
 * '<S18>'  : 'heli_q8_20155/LQR with integrator/Measurement'
 * '<S19>'  : 'heli_q8_20155/LQR with integrator/Test1'
 * '<S20>'  : 'heli_q8_20155/LQR with integrator/integrator'
 * '<S21>'  : 'heli_q8_20155/LQR with integrator/Measurement/scope'
 * '<S22>'  : 'heli_q8_20155/LQR with integrator/Test1/Refernce test'
 */
