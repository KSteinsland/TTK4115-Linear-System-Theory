...
void heli_q8_20155_output0(void)       /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_20155_M)) {
    ...
    if (heli_q8_20155_B.RateTransitionx > heli_q8_20155_P.DeadZonex_End) {
      rtb_Sum_n = heli_q8_20155_B.RateTransitionx -
     ...
     *  Gain: '<S3>/Gain: x'
     */
    heli_q8_20155_B.Joystick_gain_x = heli_q8_20155_P.Gainx_Gain * rtb_Sum_n *
    ...
    if (heli_q8_20155_B.RateTransitiony > heli_q8_20155_P.DeadZoney_End) {
      rtb_Sum_n = heli_q8_20155_B.RateTransitiony -
     ...
     *  Gain: '<S3>/Gain: y'
     */
    heli_q8_20155_B.Joystick_gain_y = heli_q8_20155_P.Gainy_Gain * rtb_Sum_n *
      heli_q8_20155_P.Joystick_gain_y;

    /* DiscretePulseGenerator: '<S22>/Pulse Generator' */
    ...
    /* End of DiscretePulseGenerator: '<S22>/Pulse Generator' */

    /* DiscretePulseGenerator: '<S22>/Pulse Generator1' */
    rtb_Sum_n = (heli_q8_20155_DW.clockTickCounter_a <
                 heli_q8_20155_P.PulseGenerator1_Duty) &&
      (heli_q8_20155_DW.clockTickCounter_a >= 0) ?
      heli_q8_20155_P.PulseGenerator1_Amp : 0.0;
    if (heli_q8_20155_DW.clockTickCounter_a >=
        heli_q8_20155_P.PulseGenerator1_Period - 1.0) {
      heli_q8_20155_DW.clockTickCounter_a = 0;
    } else {
      heli_q8_20155_DW.clockTickCounter_a++;
    }

    /* End of DiscretePulseGenerator: '<S22>/Pulse Generator1' */

    /* Sum: '<S22>/Sum1' incorporates:
     *  Constant: '<S22>/Constant'
     */
    heli_q8_20155_B.Sum1 = rtb_Sum_n - heli_q8_20155_P.Constant_Value_a;
  }

  /* Step: '<S22>/Step1' */
  rtb_Sqrt = heli_q8_20155_M->Timing.t[0];

  /* Step: '<S22>/Step2' */
  currentTime = heli_q8_20155_M->Timing.t[0];

  /* Step: '<S22>/Step' */
  if (heli_q8_20155_M->Timing.t[0] < heli_q8_20155_P.Step_Time) {
    rtb_Sum_n = heli_q8_20155_P.Step_Y0;
  } else {
    rtb_Sum_n = heli_q8_20155_P.Step_YFinal;
  }

  /* End of Step: '<S22>/Step' */

  /* Sum: '<S19>/Sum' incorporates:
   *  Gain: '<S22>/pitch_test_toggle'
   *  Sum: '<S22>/Sum3'
   */
  heli_q8_20155_B.Sum[0] = (rtb_Sum_n + heli_q8_20155_B.PulseGenerator) *
    heli_q8_20155_P.pitch_test + heli_q8_20155_B.Joystick_gain_x;

  /* Step: '<S22>/Step1' */
  if (rtb_Sqrt < heli_q8_20155_P.Step1_Time) {
    rtb_Sqrt = heli_q8_20155_P.Step1_Y0;
  } else {
    rtb_Sqrt = heli_q8_20155_P.Step1_YFinal;
  }

  /* Step: '<S22>/Step2' */
  if (currentTime < 5.0 * heli_q8_20155_P.calibrate_time) {
    currentTime = heli_q8_20155_P.Step2_Y0;
  } else {
    currentTime = heli_q8_20155_P.Step2_YFinal;
  }

  /* Sum: '<S19>/Sum' incorporates:
   *  Gain: '<S22>/elevation_test_toggle'
   *  Product: '<S22>/Product'
   *  Sum: '<S22>/Sum2'
   */
  heli_q8_20155_B.Sum[1] = (currentTime + heli_q8_20155_B.Sum1) * rtb_Sqrt *
  ...
  /* Bias: '<S5>/Bias' */
  heli_q8_20155_B.Bias = heli_q8_20155_B.Sum_jz[0] + heli_q8_20155_P.V_s0;
  if (rtmIsMajorTimeStep(heli_q8_20155_M)) {
    ...
    for (i = 0; i < 10; i++) {
      if (rtb_StreamRead1_o3) {
        ...
        heli_q8_20155_B.Switch[i] = heli_q8_20155_DW.Memory_PreviousInput[i];
      }
    }
     ...
     *  Constant: '<S7>/BIAS'
     */
    heli_q8_20155_B.Sum1_j[0] = heli_q8_20155_B.Switch1 -
      heli_q8_20155_P.imu_offset[0];
    heli_q8_20155_B.Sum1_j[1] = rtb_euler_rates[0] - heli_q8_20155_P.imu_offset
      [1];
    heli_q8_20155_B.Sum1_j[2] = heli_q8_20155_B.Switch1_o -
      heli_q8_20155_P.imu_offset[2];
    heli_q8_20155_B.Sum1_j[3] = rtb_euler_rates[1] - heli_q8_20155_P.imu_offset
      [3];
    heli_q8_20155_B.Sum1_j[4] = heli_q8_20155_P.Constant_Value_j -
      heli_q8_20155_P.imu_offset[4];
    heli_q8_20155_B.Sum1_j[5] = rtb_euler_rates[2] - heli_q8_20155_P.imu_offset
      [5];
    ...
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_C_d[i_0] = 0.0;
      for (i_1 = 0; i_1 < 6; i_1++) {
        rtb_C_d[i_0] += heli_q8_20155_P.C_d[5 * i_1 + i_0] *
          heli_q8_20155_B.Sum1_j[i_1];
      }
    }
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_Sqrt = (heli_q8_20155_B.Bias - heli_q8_20155_B.Sum_jz[1]) *
  ...
  if (rtmIsMajorTimeStep(heli_q8_20155_M)) {
    ...
    /* MATLAB Function: '<S16>/Prediction function' incorporates:
     *  UnitDelay: '<S16>/Unit Delay'
     *  UnitDelay: '<S16>/Unit Delay1'
     *  UnitDelay: '<S16>/Unit Delay2'
     */
    /* MATLAB Function 'Kalman filter/Prediction/Prediction function': '<S17>:1' */
    ...
    for (i_0 = 0; i_0 < 6; i_0++) {
      for (i_1 = 0; i_1 < 6; i_1++) {
        rtb_Sum_n = 0.0;
        for (i = 0; i < 6; i++) {
          rtb_Sum_n += tmp_6[6 * i + i_0] * heli_q8_20155_P.A_d[6 * i + i_1];
        }

        rtb_P_bar[i_0 + 6 * i_1] = heli_q8_20155_P.Q_d[6 * i_1 + i_0] +
          rtb_Sum_n;
      }
    }

    /* End of MATLAB Function: '<S16>/Prediction function' */

    /* ManualSwitch: '<S4>/Manual Switch' incorporates:
     *  Constant: '<S4>/Constant'
     */
    /*  Eq. 17e */
    /* MATLAB Function 'Kalman filter/Correction function': '<S15>:1' */
    /*  No unit delay needed */
    if (heli_q8_20155_P.ManualSwitch_CurrentSetting == 1) {
      rtb_Sum_n = rtb_StreamRead1_o3;
    } else {
      rtb_Sum_n = heli_q8_20155_P.Constant_Value_d;
    }
    ...
    if (rtb_Sum_n == 1.0) {
      ...
      for (i_0 = 0; i_0 < 5; i_0++) {
        for (i_1 = 0; i_1 < 5; i_1++) {
          rtb_Sum_n = 0.0;
          for (i = 0; i < 6; i++) {
            rtb_Sum_n += tmp_7[5 * i + i_0] * heli_q8_20155_P.C_d[5 * i + i_1];
          }

          tmp[i_0 + 5 * i_1] = heli_q8_20155_P.R_d[5 * i_1 + i_0] + rtb_Sum_n;
        }
      }
      ...
      for (i_0 = 0; i_0 < 5; i_0++) {
        rtb_Sum_n = 0.0;
        for (i_1 = 0; i_1 < 6; i_1++) {
          rtb_Sum_n += heli_q8_20155_P.C_d[5 * i_1 + i_0] * rtb_x_bar[i_1];
        }
      ...
      for (i_0 = 0; i_0 < 6; i_0++) {
        ...
        heli_q8_20155_B.x_hat[i_0] = rtb_x_bar[i_0] + rtb_Sum_n;
      }
      ...
      for (i = 0; i < 6; i++) {
        ...
        for (i_0 = 0; i_0 < 6; i_0++) {
          rtb_Sum_n = 0.0;
          for (i_1 = 0; i_1 < 5; i_1++) {
            rtb_Sum_n += rtb_L[6 * i_1 + i] * heli_q8_20155_P.C_d[5 * i_0 + i_1];
          }
      ...
      for (i_0 = 0; i_0 < 6; i_0++) {
        for (i_1 = 0; i_1 < 6; i_1++) {
          ...
          rtb_Sum_n = 0.0;
          for (i = 0; i < 5; i++) {
            rtb_Sum_n += rtb_L[6 * i + i_1] * heli_q8_20155_P.C_d[5 * i_0 + i];
          }
  ...
  /* Bias: '<S4>/Bias' */
  heli_q8_20155_B.Bias_a = heli_q8_20155_B.Bias + -heli_q8_20155_P.V_s0;
  if (rtmIsMajorTimeStep(heli_q8_20155_M)) {
    /* SignalConversion: '<S18>/TmpSignal ConversionAtTo FileInport1' */
    ...
    for (i = 0; i < 6; i++) {
      ...
      rtb_TmpSignalConversionAtToFile[i + 10] = heli_q8_20155_B.Sum1_j[i];
    }
    ...
    /* End of SignalConversion: '<S18>/TmpSignal ConversionAtTo FileInport1' */
  ...
  /* Step: '<S20>/wait calibrate' */
  if (heli_q8_20155_M->Timing.t[0] < heli_q8_20155_P.calibrate_time) {
    rtb_Sum_n = heli_q8_20155_P.waitcalibrate_Y0;
  } else {
    rtb_Sum_n = heli_q8_20155_P.waitcalibrate_YFinal;
  }

  /* End of Step: '<S20>/wait calibrate' */

  /* Product: '<S20>/Product1' incorporates:
   *  Sum: '<S20>/Sum'
   */
  heli_q8_20155_B.Product1 = (heli_q8_20155_B.ElevationTransferFcn -
    heli_q8_20155_B.Sum[1]) * rtb_Sum_n;

  /* Step: '<S20>/wait calibrate1' */
  if (heli_q8_20155_M->Timing.t[0] < heli_q8_20155_P.calibrate_time) {
    rtb_Sum_n = heli_q8_20155_P.waitcalibrate1_Y0;
  } else {
    rtb_Sum_n = heli_q8_20155_P.waitcalibrate1_YFinal;
  }

  /* End of Step: '<S20>/wait calibrate1' */

  /* Product: '<S20>/Product2' incorporates:
   *  Sum: '<S20>/Sum1'
   */
  heli_q8_20155_B.Product2 = (heli_q8_20155_B.PitchCounttorad -
    heli_q8_20155_B.Sum[0]) * rtb_Sum_n;
}
...
void heli_q8_20155_update0(void)       /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_20155_M)) {
    ...
    memcpy(&heli_q8_20155_DW.Memory_PreviousInput[0], &heli_q8_20155_B.Switch[0],
           10U * sizeof(real_T));
    ...
    heli_q8_20155_DW.UnitDelay2_DSTATE[0] = heli_q8_20155_B.Bias_a;
    heli_q8_20155_DW.UnitDelay2_DSTATE[1] = heli_q8_20155_B.Sum_jz[1];
  }
...
void heli_q8_20155_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = heli_q8_20155_B.Product1;
}
...
void heli_q8_20155_initialize(void)
{
  ...
  /* Start for DiscretePulseGenerator: '<S22>/Pulse Generator' */
  heli_q8_20155_DW.clockTickCounter = -2500;

  /* Start for DiscretePulseGenerator: '<S22>/Pulse Generator1' */
  heli_q8_20155_DW.clockTickCounter_a = -2500;
...

  {
    ...
    memcpy(&heli_q8_20155_DW.Memory_PreviousInput[0],
           &heli_q8_20155_P.Memory_X0[0], 10U * sizeof(real_T));
    ...
    /* End of InitializeConditions for UnitDelay: '<S16>/Unit Delay' */
    ...
    /* End of InitializeConditions for UnitDelay: '<S16>/Unit Delay1' */
...
void heli_q8_20155_terminate(void)
{
  ...
  /* Terminate for ToFile: '<S18>/To File' */
  {
    FILE *fp = (FILE *) heli_q8_20155_DW.ToFile_PWORK_e.FilePtr;
    if (fp != (NULL)) {
      char fileName[509] = "test.mat";
...
RT_MODEL_heli_q8_20155_T *heli_q8_20155(void)
{
  ...
  /* External mode info */
  heli_q8_20155_M->Sizes.checksums[0] = (4078611200U);
  heli_q8_20155_M->Sizes.checksums[1] = (779841543U);
  heli_q8_20155_M->Sizes.checksums[2] = (1980849223U);
  heli_q8_20155_M->Sizes.checksums[3] = (2404965303U);
...

  {
    int32_T i;
    for (i = 0; i < 10; i++) {
      heli_q8_20155_DW.Memory_PreviousInput[i] = 0.0;
    }
  }
  ...
  heli_q8_20155_M->Sizes.numBlocks = (136);/* Number of blocks */
  heli_q8_20155_M->Sizes.numBlockIO = (33);/* Number of block outputs */
  heli_q8_20155_M->Sizes.numBlockPrms = (628);/* Sum of parameter "widths" */
