/*
 * heli_q8_compare_kalman_and_luenberger.h
 *
...
#ifndef RTW_HEADER_heli_q8_compare_kalman_and_luenberger_h_
#define RTW_HEADER_heli_q8_compare_kalman_and_luenberger_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_q8_compare_kalman_and_luenberger_COMMON_INCLUDES_
# define heli_q8_compare_kalman_and_luenberger_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_compare_kalman_and_luenberger_COMMON_INCLUDES_ */

#include "heli_q8_compare_kalman_and_luenberger_types.h"
...
#define heli_q8_compare_kalman_and_luenberger_rtModel RT_MODEL_heli_q8_compare_kalm_T
...
typedef struct {
  ...
  real_T PulseGenerator;               /* '<S23>/Pulse Generator' */
  real_T Sum1;                         /* '<S23>/Sum1' */
  real_T Sum[2];                       /* '<S20>/Sum' */
  ...
  real_T Integrator1;                  /* '<S21>/Integrator1' */
  real_T Integrator;                   /* '<S21>/Integrator' */
  real_T Sum_jz[2];                    /* '<S5>/Sum' */
  real_T Bias;                         /* '<S5>/Bias' */
  real_T Switch[10];                   /* '<S7>/Switch' */
  real_T Switch1;                      /* '<S15>/Switch1' */
  real_T Switch1_o;                    /* '<S14>/Switch1' */
  real_T Sum1_j[6];                    /* '<S8>/Sum1' */
  ...
  real_T ExtractDiagonal[6];           /* '<S4>/Extract Diagonal' */
  real_T Bias_a;                       /* '<S4>/Bias' */
  real_T Integrator_d[5];              /* '<S6>/Integrator' */
  real_T Product1;                     /* '<S21>/Product1' */
  real_T Product2;                     /* '<S21>/Product2' */
  real_T Gain4[5];                     /* '<S6>/Gain4' */
  real_T Sum1_d[5];                    /* '<S6>/Sum1' */
  real_T x_hat[6];                     /* '<S4>/Correction function' */
  real_T P_hat[36];                    /* '<S4>/Correction function' */
  uint8_T StreamCall1_o2;              /* '<S7>/Stream Call1' */
} B_heli_q8_compare_kalman_and__T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T UnitDelay_DSTATE[6];          /* '<S17>/Unit Delay' */
  real_T UnitDelay1_DSTATE[36];        /* '<S17>/Unit Delay1' */
  real_T UnitDelay2_DSTATE[2];         /* '<S17>/Unit Delay2' */
  ...
  struct {
    void *LoggedData;
  } ElevationScoperads_PWORK;          /* '<S10>/Elevation: Scope [rad//s]' */

  struct {
    void *LoggedData;
  } ElevationScoperad_PWORK;           /* '<S10>/Elevation: Scope [rad]' */

  struct {
    void *LoggedData;
  } PitchScoperad_PWORK;               /* '<S10>/Pitch: Scope [rad]' */

  struct {
    void *LoggedData;
  } PtichrateScoperads_PWORK;          /* '<S10>/Ptich rate: Scope [rad//s]' */

  struct {
    void *LoggedData;
  } TravelrateScoperads_PWORK;         /* '<S10>/Travel rate: Scope [rad//s]' */

  struct {
    void *LoggedData;
  } TravelScoperad_PWORK;              /* '<S10>/Travel: Scope [rad]' */
  ...
  struct {
    void *LoggedData;
  } elevationimu_PWORK;                /* '<S13>/elevation imu' */

  struct {
    void *LoggedData;
  } pitchimu_PWORK;                    /* '<S13>/pitch imu' */
  ...
  struct {
    void *FilePtr;
  } ToFile_PWORK_e;                    /* '<S19>/To File' */

  struct {
    void *LoggedData[3];
  } Scopeelevation_PWORK;              /* '<S22>/Scope elevation' */

  struct {
    void *LoggedData[4];
  } Scopeelevationrate_PWORK;          /* '<S22>/Scope elevation rate' */

  struct {
    void *LoggedData[4];
  } Scopepitch_PWORK;                  /* '<S22>/Scope pitch' */

  struct {
    void *LoggedData[3];
  } Scopepitchrate_PWORK;              /* '<S22>/Scope pitch rate' */

  struct {
    void *LoggedData[3];
  } Scopetravel_PWORK;                 /* '<S22>/Scope travel' */

  struct {
    void *LoggedData[3];
  } Scopetravelrate_PWORK;             /* '<S22>/Scope travel rate' */

  struct {
    void *LoggedData;
  } ScopeV_d_PWORK;                    /* '<S22>/Scope V_d' */

  struct {
    void *LoggedData;
  } ScopeV_s_PWORK;                    /* '<S22>/Scope V_s' */

  struct {
    void *LoggedData;
  } Scopegamma_PWORK;                  /* '<S22>/Scope gamma' */

  struct {
    void *LoggedData;
  } Scopezeta_PWORK;                   /* '<S22>/Scope zeta' */

  struct {
    void *LoggedData;
  } Scopegamma_PWORK_a;                /* '<S5>/Scope gamma' */

  struct {
    void *LoggedData;
  } Scopezeta_PWORK_n;                 /* '<S5>/Scope zeta' */
  ...
  int32_T clockTickCounter;            /* '<S23>/Pulse Generator' */
  int32_T clockTickCounter_a;          /* '<S23>/Pulse Generator1' */
  ...
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK_j;                    /* '<S19>/To File' */

  uint8_T StreamCall1_State;           /* '<S7>/Stream Call1' */
} DW_heli_q8_compare_kalman_and_T;
...
typedef struct {
  ...
  real_T Integrator_CSTATE_e[5];       /* '<S6>/Integrator' */
} X_heli_q8_compare_kalman_and__T;
...
typedef struct {
  ...
  real_T Integrator_CSTATE;            /* '<S21>/Integrator' */
  real_T Integrator_CSTATE_e[5];       /* '<S6>/Integrator' */
} XDot_heli_q8_compare_kalman_a_T;
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_e[5];    /* '<S6>/Integrator' */
} XDis_heli_q8_compare_kalman_a_T;
...
#define rtB                            heli_q8_compare_kalman_and_lu_B
#define BlockIO                        B_heli_q8_compare_kalman_and__T
#define rtX                            heli_q8_compare_kalman_and_lu_X
#define ContinuousStates               X_heli_q8_compare_kalman_and__T
#define rtXdot                         heli_q8_compare_kalman_and_XDot
#define StateDerivatives               XDot_heli_q8_compare_kalman_a_T
#define tXdis                          heli_q8_compare_kalman_and_XDis
#define StateDisabled                  XDis_heli_q8_compare_kalman_a_T
#define rtP                            heli_q8_compare_kalman_and_lu_P
#define Parameters                     P_heli_q8_compare_kalman_and__T
#define rtDWork                        heli_q8_compare_kalman_and_l_DW
#define D_Work                         DW_heli_q8_compare_kalman_and_T

/* Parameters (auto storage) */
struct P_heli_q8_compare_kalman_and__T_ {
  real_T A_d[36];                      /* Variable: A_d
                                        * Referenced by: '<S17>/Prediction function'
                                        */
  real_T A_luen[25];                   /* Variable: A_luen
                                        * Referenced by: '<S6>/Gain2'
                                        */
  real_T B_d[12];                      /* Variable: B_d
                                        * Referenced by: '<S17>/Prediction function'
                                        */
  real_T B_luen[10];                   /* Variable: B_luen
  ...
  real_T C_d[30];                      /* Variable: C_d
                                        ...
                                        */
  real_T C_luen[25];                   /* Variable: C_luen
                                        * Referenced by:
                                        *   '<S6>/Gain1'
                                        *   '<S6>/Gain4'
                                        */
  ...
  real_T V_s0;                         /* Variable: V_s0
                                        ...
                                        *   '<S6>/Bias'
                                        */
  real_T calibrate_time;               /* Variable: calibrate_time
                                        * Referenced by:
                                        *   '<S21>/wait calibrate'
                                        *   '<S21>/wait calibrate1'
                                        *   '<S23>/Step2'
  ...
  real_T elevation_offset;             /* Variable: elevation_offset
                                        ...
                                        *   '<S14>/Constant1'
                                        */
  real_T elevation_test;               /* Variable: elevation_test
                                        * Referenced by: '<S23>/elevation_test_toggle'
                                        */
  real_T imu_offset[6];                /* Variable: imu_offset
                                        * Referenced by: '<S8>/BIAS'
                                        */
  real_T pitch_test;                   /* Variable: pitch_test
  ...
  real_T RateTransitiony_X0;           /* Expression: 0
                                        ...
                                        */
  real_T DeadZoney_Start;              /* Expression: -0.2
                                        * Referenced by: '<S3>/Dead Zone: y'
                                        */
  real_T DeadZoney_End;                /* Expression: 0.2
                                        * Referenced by: '<S3>/Dead Zone: y'
                                        */
  ...
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<S23>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: -0.25
                                        * Referenced by: '<S23>/Step'
                                        */
  ...
  real_T Step1_YFinal;                 /* Expression: 1
                                        * Referenced by: '<S23>/Step1'
                                        */
  real_T Step2_Y0;                     /* Expression: 0.1
                                        * Referenced by: '<S23>/Step2'
                                        */
  real_T Step2_YFinal;                 /* Expression: 0
                                        * Referenced by: '<S23>/Step2'
                                        */
  real_T PulseGenerator1_Amp;          /* Expression: 0.2
  ...
  real_T PulseGenerator1_Duty;         /* Computed Parameter: PulseGenerator1_Duty
                                        * Referenced by: '<S23>/Pulse Generator1'
                                        */
  real_T PulseGenerator1_PhaseDelay;   /* Expression: 5
                                        * Referenced by: '<S23>/Pulse Generator1'
                                        */
  real_T Constant_Value_a;             /* Expression: 0.1
  ...
  real_T Constant_Value_c;             /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_d;            /* Expression: 65
  ...
  real_T Integrator_IC_g;              /* Expression: 0
                                        ...
                                        */
  real_T waitcalibrate_Y0;             /* Expression: 0
                                        * Referenced by: '<S21>/wait calibrate'
                                        */
  real_T waitcalibrate_YFinal;         /* Expression: 1
                                        * Referenced by: '<S21>/wait calibrate'
                                        */
  real_T waitcalibrate1_Y0;            /* Expression: 0
                                        * Referenced by: '<S21>/wait calibrate1'
                                        */
  real_T waitcalibrate1_YFinal;        /* Expression: 1
                                        * Referenced by: '<S21>/wait calibrate1'
                                        */
...
struct tag_RTM_heli_q8_compare_kalma_T {
  const char_T *path;
...
extern P_heli_q8_compare_kalman_and__T heli_q8_compare_kalman_and_lu_P;

/* Block signals (auto storage) */
extern B_heli_q8_compare_kalman_and__T heli_q8_compare_kalman_and_lu_B;

/* Continuous states (auto storage) */
extern X_heli_q8_compare_kalman_and__T heli_q8_compare_kalman_and_lu_X;

/* Block states (auto storage) */
extern DW_heli_q8_compare_kalman_and_T heli_q8_compare_kalman_and_l_DW;
...
extern void heli_q8_compare_kalman_and_luenberger_initialize(void);
extern void heli_q8_compare_kalman_and_luenberger_output0(void);
extern void heli_q8_compare_kalman_and_luenberger_update0(void);
extern void heli_q8_compare_kalman_and_luenberger_output(int_T tid);
extern void heli_q8_compare_kalman_and_luenberger_update(int_T tid);
extern void heli_q8_compare_kalman_and_luenberger_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_compare_kalman_and_luenberger_rtModel
  *heli_q8_compare_kalman_and_luenberger(void);
...
extern RT_MODEL_heli_q8_compare_kalm_T *const heli_q8_compare_kalman_and_l_M;
 ...
 *
 * '<Root>' : 'heli_q8_compare_kalman_and_luenberger'
 * '<S1>'   : 'heli_q8_compare_kalman_and_luenberger/Conversion'
 * '<S2>'   : 'heli_q8_compare_kalman_and_luenberger/Heli 3D'
 * '<S3>'   : 'heli_q8_compare_kalman_and_luenberger/Joystick'
 * '<S4>'   : 'heli_q8_compare_kalman_and_luenberger/Kalman filter'
 * '<S5>'   : 'heli_q8_compare_kalman_and_luenberger/LQR with integrator'
 * '<S6>'   : 'heli_q8_compare_kalman_and_luenberger/state estimator'
 * '<S7>'   : 'heli_q8_compare_kalman_and_luenberger/Heli 3D/IMU1'
 * '<S8>'   : 'heli_q8_compare_kalman_and_luenberger/Heli 3D/Measurement'
 * '<S9>'   : 'heli_q8_compare_kalman_and_luenberger/Heli 3D/Motor driver'
 * '<S10>'  : 'heli_q8_compare_kalman_and_luenberger/Heli 3D/Subsystem'
 * '<S11>'  : 'heli_q8_compare_kalman_and_luenberger/Heli 3D/Measurement/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S12>'  : 'heli_q8_compare_kalman_and_luenberger/Heli 3D/Measurement/convert to x'
 * '<S13>'  : 'heli_q8_compare_kalman_and_luenberger/Heli 3D/Measurement/imu angles'
 * '<S14>'  : 'heli_q8_compare_kalman_and_luenberger/Heli 3D/Measurement/imu angles/elevation_eq'
 * '<S15>'  : 'heli_q8_compare_kalman_and_luenberger/Heli 3D/Measurement/imu angles/pitch_eq'
 * '<S16>'  : 'heli_q8_compare_kalman_and_luenberger/Kalman filter/Correction function'
 * '<S17>'  : 'heli_q8_compare_kalman_and_luenberger/Kalman filter/Prediction'
 * '<S18>'  : 'heli_q8_compare_kalman_and_luenberger/Kalman filter/Prediction/Prediction function'
 * '<S19>'  : 'heli_q8_compare_kalman_and_luenberger/LQR with integrator/Measurement'
 * '<S20>'  : 'heli_q8_compare_kalman_and_luenberger/LQR with integrator/Test1'
 * '<S21>'  : 'heli_q8_compare_kalman_and_luenberger/LQR with integrator/integrator'
 * '<S22>'  : 'heli_q8_compare_kalman_and_luenberger/LQR with integrator/Measurement/scope'
 * '<S23>'  : 'heli_q8_compare_kalman_and_luenberger/LQR with integrator/Test1/Refernce test'
 */
#endif                                 /* RTW_HEADER_heli_q8_compare_kalman_and_luenberger_h_ */
