...
MODEL                = heli_q8_presentation
MODULES              = heli_q8_presentation_data.c heli_q8_presentation_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_presentation.mk
...
MODELLIB                  = heli_q8_presentationlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_presentation_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_presentation_quarc_win64
