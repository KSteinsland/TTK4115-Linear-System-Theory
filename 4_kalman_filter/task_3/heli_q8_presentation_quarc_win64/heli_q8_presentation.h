...
#ifndef RTW_HEADER_heli_q8_presentation_h_
#define RTW_HEADER_heli_q8_presentation_h_
#include <math.h>
#include <string.h>
#ifndef heli_q8_presentation_COMMON_INCLUDES_
# define heli_q8_presentation_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_presentation_COMMON_INCLUDES_ */

#include "heli_q8_presentation_types.h"
...
#define heli_q8_presentation_rtModel   RT_MODEL_heli_q8_presentation_T
...
#define rtB                            heli_q8_presentation_B
#define BlockIO                        B_heli_q8_presentation_T
#define rtX                            heli_q8_presentation_X
#define ContinuousStates               X_heli_q8_presentation_T
#define rtXdot                         heli_q8_presentation_XDot
#define StateDerivatives               XDot_heli_q8_presentation_T
#define tXdis                          heli_q8_presentation_XDis
#define StateDisabled                  XDis_heli_q8_presentation_T
#define rtP                            heli_q8_presentation_P
#define Parameters                     P_heli_q8_presentation_T
#define rtDWork                        heli_q8_presentation_DW
#define D_Work                         DW_heli_q8_presentation_T

/* Parameters (auto storage) */
struct P_heli_q8_presentation_T_ {
...
struct tag_RTM_heli_q8_presentation_T {
  const char_T *path;
...
extern P_heli_q8_presentation_T heli_q8_presentation_P;

/* Block signals (auto storage) */
extern B_heli_q8_presentation_T heli_q8_presentation_B;

/* Continuous states (auto storage) */
extern X_heli_q8_presentation_T heli_q8_presentation_X;

/* Block states (auto storage) */
extern DW_heli_q8_presentation_T heli_q8_presentation_DW;
...
extern void heli_q8_presentation_initialize(void);
extern void heli_q8_presentation_output0(void);
extern void heli_q8_presentation_update0(void);
extern void heli_q8_presentation_output(int_T tid);
extern void heli_q8_presentation_update(int_T tid);
extern void heli_q8_presentation_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_presentation_rtModel *heli_q8_presentation(void);
...
extern RT_MODEL_heli_q8_presentation_T *const heli_q8_presentation_M;
 ...
 *
 * '<Root>' : 'heli_q8_presentation'
 * '<S1>'   : 'heli_q8_presentation/Conversion'
 * '<S2>'   : 'heli_q8_presentation/Heli 3D'
 * '<S3>'   : 'heli_q8_presentation/Joystick'
 * '<S4>'   : 'heli_q8_presentation/LQR with integrator'
 * '<S5>'   : 'heli_q8_presentation/state estimator'
 * '<S6>'   : 'heli_q8_presentation/Heli 3D/IMU1'
 * '<S7>'   : 'heli_q8_presentation/Heli 3D/Measurement'
 * '<S8>'   : 'heli_q8_presentation/Heli 3D/Motor driver'
 * '<S9>'   : 'heli_q8_presentation/Heli 3D/Subsystem'
 * '<S10>'  : 'heli_q8_presentation/Heli 3D/Measurement/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S11>'  : 'heli_q8_presentation/Heli 3D/Measurement/convert to x'
 * '<S12>'  : 'heli_q8_presentation/Heli 3D/Measurement/imu angles'
 * '<S13>'  : 'heli_q8_presentation/Heli 3D/Measurement/imu angles/elevation_eq'
 * '<S14>'  : 'heli_q8_presentation/Heli 3D/Measurement/imu angles/pitch_eq'
 * '<S15>'  : 'heli_q8_presentation/LQR with integrator/integrator'
 */
#endif                                 /* RTW_HEADER_heli_q8_presentation_h_ */
