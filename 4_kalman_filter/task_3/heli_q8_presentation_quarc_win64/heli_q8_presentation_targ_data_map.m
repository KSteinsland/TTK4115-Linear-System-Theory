  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% heli_q8_presentation_P.HILInitialize_set_other_outputs
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 122;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_other_outpu_m
	  section.data(23).logicalSrcIdx = 22;
	  section.data(23).dtTransOffset = 123;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_other_outpu_k
	  section.data(24).logicalSrcIdx = 23;
	  section.data(24).dtTransOffset = 124;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_other_outpu_j
	  ...
	  ;% heli_q8_presentation_P.HILReadEncoderTimebase_clock
	  section.data(1).logicalSrcIdx = 27;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_presentation_P.HILInitialize_hardware_clocks
	  ...
	  ;% heli_q8_presentation_P.HILInitialize_pwm_modes
	  ...
	  ;% heli_q8_presentation_P.HILInitialize_watchdog_digital_
	  ...
	  ;% heli_q8_presentation_P.HILInitialize_analog_input_chan
	  ...
	  ;% heli_q8_presentation_P.HILReadEncoderTimebase_channels
	  section.data(3).logicalSrcIdx = 37;
	  section.data(3).dtTransOffset = 16;
	
	  ;% heli_q8_presentation_P.HILWriteAnalog_channels
	  section.data(4).logicalSrcIdx = 38;
	  section.data(4).dtTransOffset = 19;
	
	  ;% heli_q8_presentation_P.HILInitialize_encoder_channels
	  ...
	  ;% heli_q8_presentation_P.HILInitialize_active
	  section.data(1).logicalSrcIdx = 43;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_presentation_P.HILInitialize_final_digital_out
	  section.data(2).logicalSrcIdx = 44;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_presentation_P.HILInitialize_initial_digital_o
	  section.data(3).logicalSrcIdx = 45;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_analog_input_
	  ...
	  ;% heli_q8_presentation_P.HILInitialize_set_analog_output
	  ...
	  ;% heli_q8_presentation_P.HILInitialize_set_analog_outp_e
	  ...
	  ;% heli_q8_presentation_P.HILInitialize_set_analog_out_ex
	  section.data(11).logicalSrcIdx = 53;
	  section.data(11).dtTransOffset = 10;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_analog_outp_p
	  section.data(12).logicalSrcIdx = 54;
	  section.data(12).dtTransOffset = 11;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_clock_frequen
	  section.data(13).logicalSrcIdx = 55;
	  section.data(13).dtTransOffset = 12;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_clock_frequ_e
	  section.data(14).logicalSrcIdx = 56;
	  section.data(14).dtTransOffset = 13;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_clock_params_
	  section.data(15).logicalSrcIdx = 57;
	  section.data(15).dtTransOffset = 14;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_clock_param_c
	  section.data(16).logicalSrcIdx = 58;
	  section.data(16).dtTransOffset = 15;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_digital_outpu
	  section.data(17).logicalSrcIdx = 59;
	  section.data(17).dtTransOffset = 16;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_digital_out_b
	  section.data(18).logicalSrcIdx = 60;
	  section.data(18).dtTransOffset = 17;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_digital_out_c
	  section.data(19).logicalSrcIdx = 61;
	  section.data(19).dtTransOffset = 18;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_digital_ou_c1
	  section.data(20).logicalSrcIdx = 62;
	  section.data(20).dtTransOffset = 19;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_digital_out_a
	  section.data(21).logicalSrcIdx = 63;
	  section.data(21).dtTransOffset = 20;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_digital_out_j
	  section.data(22).logicalSrcIdx = 64;
	  section.data(22).dtTransOffset = 21;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_digital_out_m
	  section.data(23).logicalSrcIdx = 65;
	  section.data(23).dtTransOffset = 22;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_encoder_count
	  ...
	  ;% heli_q8_presentation_P.HILInitialize_set_encoder_param
	  ...
	  ;% heli_q8_presentation_P.HILInitialize_set_other_outpu_l
	  section.data(28).logicalSrcIdx = 70;
	  section.data(28).dtTransOffset = 27;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_pwm_outputs_a
	  ...
	  ;% heli_q8_presentation_P.HILInitialize_set_pwm_output_ap
	  section.data(32).logicalSrcIdx = 74;
	  section.data(32).dtTransOffset = 31;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_pwm_outputs_o
	  section.data(33).logicalSrcIdx = 75;
	  section.data(33).dtTransOffset = 32;
	
	  ;% heli_q8_presentation_P.HILInitialize_set_pwm_params_at
	  ...
	  ;% heli_q8_presentation_P.Constant1_Value
	  section.data(1).logicalSrcIdx = 78;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_presentation_P.Constant_Value
	  section.data(2).logicalSrcIdx = 79;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_presentation_P.Constant1_Value_c
	  section.data(3).logicalSrcIdx = 80;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_presentation_P.Constant_Value_g
	  ...
	  ;% heli_q8_presentation_P.Gainx_Gain
	  ...
	  ;% heli_q8_presentation_P.Gainy_Gain
	  ...
	  ;% heli_q8_presentation_P.PitchTransferFcn_A
	  ...
	  ;% heli_q8_presentation_P.GameController_BufferSize
	  ...
	  ;% heli_q8_presentation_P.StringConstant_Value
	  section.data(1).logicalSrcIdx = 123;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_presentation_P.StreamCall1_URI
	  ...
	  ;% heli_q8_presentation_P.HILReadEncoderTimebase_Active
	  section.data(1).logicalSrcIdx = 127;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_presentation_P.StreamCall1_Active
	  section.data(2).logicalSrcIdx = 128;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_presentation_P.HILWriteAnalog_Active
	  section.data(3).logicalSrcIdx = 129;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_presentation_P.GameController_AutoCenter
	  section.data(4).logicalSrcIdx = 130;
	  section.data(4).dtTransOffset = 3;
	
	  ;% heli_q8_presentation_P.GameController_Enabled
  ...
  ;%**************************
    ...
    ;%
    ;% Auto data (heli_q8_presentation_B)
    ;%
      section.nData     = 24;
	  ...
	  ;% heli_q8_presentation_B.Gain1
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 4;
	
	  ;% heli_q8_presentation_B.Sum
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 6;
	
	  ;% heli_q8_presentation_B.V_s0
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 8;
	
	  ;% heli_q8_presentation_B.Sum1
	  section.data(8).logicalSrcIdx = 7;
	  section.data(8).dtTransOffset = 9;
	
	  ;% heli_q8_presentation_B.Switch
	  section.data(9).logicalSrcIdx = 8;
	  ...
	  ;% heli_q8_presentation_B.Sum_n
	  section.data(21).logicalSrcIdx = 20;
	  section.data(21).dtTransOffset = 31;
	
	  ;% heli_q8_presentation_B.Sum1_h
	  section.data(22).logicalSrcIdx = 21;
	  section.data(22).dtTransOffset = 32;
	
	  ;% heli_q8_presentation_B.Gain4
	  section.data(23).logicalSrcIdx = 22;
	  section.data(23).dtTransOffset = 33;
	
	  ;% heli_q8_presentation_B.Sum1_e
	  section.data(24).logicalSrcIdx = 23;
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (heli_q8_presentation_DW)
    ;%
      section.nData     = 12;
      section.data(12)  = dumData; %prealloc
      
	  ;% heli_q8_presentation_DW.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_presentation_DW.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 8;
	
	  ;% heli_q8_presentation_DW.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 16;
	
	  ;% heli_q8_presentation_DW.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 24;
	
	  ;% heli_q8_presentation_DW.HILInitialize_AOVoltages
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 32;
	
	  ;% heli_q8_presentation_DW.HILInitialize_FilterFrequency
	  section.data(6).logicalSrcIdx = 5;
	  section.data(6).dtTransOffset = 40;
	
	  ;% heli_q8_presentation_DW.HILInitialize_POSortedFreqs
	  section.data(7).logicalSrcIdx = 6;
	  section.data(7).dtTransOffset = 48;
	
	  ;% heli_q8_presentation_DW.HILInitialize_POValues
	  section.data(8).logicalSrcIdx = 7;
	  ...
	  ;% heli_q8_presentation_DW.Memory_PreviousInput
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 66;
	
	  ;% heli_q8_presentation_DW.HILWriteAnalog_Buffer
	  section.data(12).logicalSrcIdx = 11;
	  ...
	  ;% heli_q8_presentation_DW.u_PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 16;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_presentation_DW.Connected_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 17;
	  section.data(2).dtTransOffset = 2;
	
	  ;% heli_q8_presentation_DW.HILWriteAnalog_PWORK
	  section.data(3).logicalSrcIdx = 18;
	  section.data(3).dtTransOffset = 3;
	
	  ;% heli_q8_presentation_DW.Scope_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 19;
	  section.data(4).dtTransOffset = 4;
	
	  ;% heli_q8_presentation_DW.ElevationScoperads_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 20;
	  section.data(5).dtTransOffset = 6;
	
	  ;% heli_q8_presentation_DW.ElevationScoperad_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 21;
	  section.data(6).dtTransOffset = 7;
	
	  ;% heli_q8_presentation_DW.PitchScoperad_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 22;
	  section.data(7).dtTransOffset = 8;
	
	  ;% heli_q8_presentation_DW.PtichrateScoperads_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 23;
	  section.data(8).dtTransOffset = 9;
	
	  ;% heli_q8_presentation_DW.TravelrateScoperads_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 24;
	  section.data(9).dtTransOffset = 10;
	
	  ;% heli_q8_presentation_DW.TravelScoperad_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 25;
	  section.data(10).dtTransOffset = 11;
	
	  ;% heli_q8_presentation_DW.XScope_PWORK.LoggedData
	  section.data(11).logicalSrcIdx = 26;
	  section.data(11).dtTransOffset = 12;
	
	  ;% heli_q8_presentation_DW.YScope_PWORK.LoggedData
	  ...
	  ;% heli_q8_presentation_DW.HILInitialize_ClockModes
	  section.data(1).logicalSrcIdx = 28;
	  section.data(1).dtTransOffset = 0;
	
	  ;% heli_q8_presentation_DW.HILInitialize_QuadratureModes
	  section.data(2).logicalSrcIdx = 29;
	  section.data(2).dtTransOffset = 3;
	
	  ;% heli_q8_presentation_DW.HILInitialize_InitialEICounts
	  section.data(3).logicalSrcIdx = 30;
	  section.data(3).dtTransOffset = 11;
	
	  ;% heli_q8_presentation_DW.HILInitialize_POModeValues
	  section.data(4).logicalSrcIdx = 31;
	  section.data(4).dtTransOffset = 19;
	
	  ;% heli_q8_presentation_DW.HILInitialize_POAlignValues
	  section.data(5).logicalSrcIdx = 32;
	  section.data(5).dtTransOffset = 27;
	
	  ;% heli_q8_presentation_DW.HILInitialize_POPolarityVals
	  section.data(6).logicalSrcIdx = 33;
	  section.data(6).dtTransOffset = 35;
	
	  ;% heli_q8_presentation_DW.HILReadEncoderTimebase_Buffer
	  ...
	  ;% heli_q8_presentation_DW.HILInitialize_POSortedChans
	  section.data(1).logicalSrcIdx = 35;
	  section.data(1).dtTransOffset = 0;
  ...
  targMap.checksum0 = 1306831641;
  targMap.checksum1 = 2532077358;
  targMap.checksum2 = 3873529359;
  targMap.checksum3 = 4278721867;
