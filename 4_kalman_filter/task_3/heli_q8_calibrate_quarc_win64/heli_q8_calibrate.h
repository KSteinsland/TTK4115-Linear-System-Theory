...
#ifndef RTW_HEADER_heli_q8_calibrate_h_
#define RTW_HEADER_heli_q8_calibrate_h_
#include <math.h>
#include <string.h>
#ifndef heli_q8_calibrate_COMMON_INCLUDES_
# define heli_q8_calibrate_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_calibrate_COMMON_INCLUDES_ */

#include "heli_q8_calibrate_types.h"
...
#define heli_q8_calibrate_rtModel      RT_MODEL_heli_q8_calibrate_T
...
typedef struct {
  ...
  real_T Memory_a;                     /* '<S8>/Memory' */
  real_T Divide_d;                     /* '<S8>/Divide' */
  real_T Memory_d;                     /* '<S9>/Memory' */
  real_T Divide_g;                     /* '<S9>/Divide' */
  real_T Memory_dh;                    /* '<S10>/Memory' */
  real_T Divide_h;                     /* '<S10>/Divide' */
  real_T Memory_k;                     /* '<S11>/Memory' */
  real_T Divide_k;                     /* '<S11>/Divide' */
  real_T Product[5];                   /* '<S3>/Product' */
  real_T Switch[10];                   /* '<S1>/Switch' */
  real_T Switch1;                      /* '<S13>/Switch1' */
  real_T Sum;                          /* '<S7>/Sum' */
  real_T Switch_j;                     /* '<S7>/Switch' */
  real_T Switch1_o;                    /* '<S12>/Switch1' */
  real_T Sum_b;                        /* '<S8>/Sum' */
  real_T Switch_d;                     /* '<S8>/Switch' */
  real_T Sum_l;                        /* '<S9>/Sum' */
  real_T Switch_k;                     /* '<S9>/Switch' */
  real_T Sum_k;                        /* '<S10>/Sum' */
  real_T Switch_e;                     /* '<S10>/Switch' */
  real_T Sum_a;                        /* '<S11>/Sum' */
  real_T Switch_h;                     /* '<S11>/Switch' */
  uint8_T StreamCall1_o2;              /* '<S1>/Stream Call1' */
} B_heli_q8_calibrate_T;
...
typedef struct {
  ...
  real_T Memory_PreviousInput_p;       /* '<S8>/Memory' */
  real_T Memory_PreviousInput_ps;      /* '<S9>/Memory' */
  real_T Memory_PreviousInput_l;       /* '<S10>/Memory' */
  real_T Memory_PreviousInput_i;       /* '<S11>/Memory' */
  real_T Memory_PreviousInput_c[10];   /* '<S1>/Memory' */
  ...
  struct {
    void *LoggedData;
  } elevationimu_PWORK;                /* '<S6>/elevation imu' */

  struct {
    void *LoggedData;
  } pitchimu_PWORK;                    /* '<S6>/pitch imu' */
...
} DW_heli_q8_calibrate_T;

/* Backward compatible GRT Identifiers */
#define rtB                            heli_q8_calibrate_B
#define BlockIO                        B_heli_q8_calibrate_T
#define rtP                            heli_q8_calibrate_P
#define Parameters                     P_heli_q8_calibrate_T
#define rtDWork                        heli_q8_calibrate_DW
#define D_Work                         DW_heli_q8_calibrate_T

/* Parameters (auto storage) */
struct P_heli_q8_calibrate_T_ {
  ...
  real_T Step_Y0_b;                    /* Expression: 1
                                        ...
                                        */
  real_T Step_YFinal_dc;               /* Expression: 0
                                        * Referenced by: '<S10>/Step'
                                        */
  ...
  real_T Step_Y0_o;                    /* Expression: 1
                                        ...
                                        */
  real_T Step_YFinal_m4;               /* Expression: 0
                                        * Referenced by: '<S11>/Step'
                                        */
  real_T Step1_Y0_j;                   /* Expression: 1
...
struct tag_RTM_heli_q8_calibrate_T {
  const char_T *path;
...
extern P_heli_q8_calibrate_T heli_q8_calibrate_P;

/* Block signals (auto storage) */
extern B_heli_q8_calibrate_T heli_q8_calibrate_B;

/* Block states (auto storage) */
extern DW_heli_q8_calibrate_T heli_q8_calibrate_DW;

/* Model entry point functions */
extern void heli_q8_calibrate_initialize(void);
extern void heli_q8_calibrate_output(void);
extern void heli_q8_calibrate_update(void);
extern void heli_q8_calibrate_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_calibrate_rtModel *heli_q8_calibrate(void);
...
extern RT_MODEL_heli_q8_calibrate_T *const heli_q8_calibrate_M;
 ...
 *
 * '<Root>' : 'heli_q8_calibrate'
 * '<S1>'   : 'heli_q8_calibrate/IMU1'
 * '<S2>'   : 'heli_q8_calibrate/Measurement'
 * '<S3>'   : 'heli_q8_calibrate/Measurement/Calibrate'
 * '<S4>'   : 'heli_q8_calibrate/Measurement/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S5>'   : 'heli_q8_calibrate/Measurement/convert to x'
 * '<S6>'   : 'heli_q8_calibrate/Measurement/imu angles'
 * '<S7>'   : 'heli_q8_calibrate/Measurement/Calibrate/calibrate'
 * '<S8>'   : 'heli_q8_calibrate/Measurement/Calibrate/calibrate1'
 * '<S9>'   : 'heli_q8_calibrate/Measurement/Calibrate/calibrate2'
 * '<S10>'  : 'heli_q8_calibrate/Measurement/Calibrate/calibrate3'
 * '<S11>'  : 'heli_q8_calibrate/Measurement/Calibrate/calibrate5'
 * '<S12>'  : 'heli_q8_calibrate/Measurement/imu angles/elevation_eq'
 * '<S13>'  : 'heli_q8_calibrate/Measurement/imu angles/pitch_eq'
 */
#endif                                 /* RTW_HEADER_heli_q8_calibrate_h_ */
