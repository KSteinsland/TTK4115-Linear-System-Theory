...
typedef struct {
  ...
  real_T offsettogetzerotravel;        /* '<S5>/offset to get zero travel' */
...
struct P_heli_q8_2015_T_ {
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T offsettogetzerotravel_Bias;   /* Expression: 0
                                        * Referenced by: '<S5>/offset to get zero travel'
                                        */
  real_T imuoffset_Bias;               /* Expression: 0
