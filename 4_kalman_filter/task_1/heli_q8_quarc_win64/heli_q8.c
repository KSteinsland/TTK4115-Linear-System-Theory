 ...
 * C source code generated on : Sun Oct 18 13:59:55 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* DiscretePulseGenerator: '<S12>/Pulse Generator1' */
    heli_q8_B.PulseGenerator1 = (heli_q8_DW.clockTickCounter_e <
      heli_q8_P.PulseGenerator1_Duty) && (heli_q8_DW.clockTickCounter_e >= 0) ?
      heli_q8_P.PulseGenerator1_Amp : 0.0;
    if (heli_q8_DW.clockTickCounter_e >= heli_q8_P.PulseGenerator1_Period - 1.0)
    {
      heli_q8_DW.clockTickCounter_e = 0;
    } else {
      heli_q8_DW.clockTickCounter_e++;
    }

    /* End of DiscretePulseGenerator: '<S12>/Pulse Generator1' */
  }
  ...
  if (heli_q8_M->Timing.t[0] < heli_q8_P.Step_Time) {
    rtb_Sqrt = heli_q8_P.Step_Y0;
  } else {
    rtb_Sqrt = heli_q8_P.Step_YFinal;
  }

  /* End of Step: '<S12>/Step' */

  /* Sum: '<S10>/Sum' incorporates:
   *  Gain: '<S12>/pitch_test_toggle'
   *  Sum: '<S12>/Sum3'
   */
  heli_q8_B.Sum[0] = (rtb_Sqrt + heli_q8_B.PulseGenerator) *
    heli_q8_P.pitch_test + heli_q8_B.Joystick_gain_x;

  /* Step: '<S12>/Step1' */
  if (currentTime < heli_q8_P.Step1_Time) {
    currentTime = heli_q8_P.Step1_Y0;
  } else {
    currentTime = heli_q8_P.Step1_YFinal;
  }

  /* Sum: '<S10>/Sum' incorporates:
   *  Gain: '<S12>/elevation_test_toggle'
   *  Sum: '<S12>/Sum1'
   */
  heli_q8_B.Sum[1] = (currentTime + heli_q8_B.PulseGenerator1) *
    heli_q8_P.elevation_test + heli_q8_B.Joystick_gain_y;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum_j = heli_q8_B.ElevationCounttorad - heli_q8_P.Constant_Value_f;
  }
  ...
  rtb_Gain[0] = heli_q8_B.PitchCounttorad;
  rtb_Gain[1] = heli_q8_B.PitchTransferFcn;
  rtb_Gain[2] = heli_q8_B.Sum_j;
  rtb_Gain[3] = heli_q8_B.ElevationTransferFcn;
  rtb_Gain[4] = heli_q8_B.TravelTransferFcn;
  rtb_Gain[5] = heli_q8_B.Integrator1;
  rtb_Gain[6] = heli_q8_B.Integrator;
  for (i = 0; i < 2; i++) {
    /* Gain: '<S5>/Gain1' incorporates:
     *  Sum: '<S5>/Sum'
     */
    tmp[i] = 0.0;
    tmp[i] += heli_q8_P.F[i] * heli_q8_B.Sum[0];
    tmp[i] += heli_q8_P.F[i + 2] * heli_q8_B.Sum[1];
    ...
    tmp_0[i] = 0.0;
    for (i_0 = 0; i_0 < 7; i_0++) {
      tmp_0[i] += heli_q8_P.K[(i_0 << 1) + i] * rtb_Gain[i_0];
    }

    /* End of Gain: '<S5>/Gain' */

    /* Sum: '<S5>/Sum' */
    heli_q8_B.Sum_jz[i] = tmp[i] - tmp_0[i];
  }
  ...
  /* Sum: '<S5>/Sum1' */
  heli_q8_B.Sum1 = heli_q8_B.Sum_jz[0] + heli_q8_B.V_s0;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }

  /* Integrator: '<S8>/Integrator' */
  for (i = 0; i < 7; i++) {
    heli_q8_B.Integrator_a[i] = heli_q8_X.Integrator_CSTATE_j[i];
  }
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_Sqrt = (heli_q8_B.Sum1 - heli_q8_B.Sum_jz[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  rtb_Sqrt = (heli_q8_B.Sum1 + heli_q8_B.Sum_jz[1]) * heli_q8_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* S-Function (stream_formatted_write_block): '<S3>/Stream Formatted Write' */
    {
      ...
      if (rtb_StreamCall1_o1 != NULL) {
        result = stream_print_utf8_char_array(*rtb_StreamCall1_o1,
          ...
          "%c\n"
          , (char) heli_q8_P.Constant1_Value_d
          );
        if (result > 0) {
    ...
    /* SignalConversion: '<S10>/TmpSignal ConversionAtTo FileInport1' */
    rtb_TmpSignalConversionAtToFile[0] = heli_q8_B.Sum[0];
    rtb_TmpSignalConversionAtToFile[2] = heli_q8_B.Sum_jz[0];
    rtb_TmpSignalConversionAtToFile[1] = heli_q8_B.Sum[1];
    rtb_TmpSignalConversionAtToFile[3] = heli_q8_B.Sum_jz[1];
    rtb_TmpSignalConversionAtToFile[4] = heli_q8_B.TravelCounttorad;
    rtb_TmpSignalConversionAtToFile[5] = heli_q8_B.TravelTransferFcn;
    rtb_TmpSignalConversionAtToFile[6] = heli_q8_B.PitchCounttorad;
    rtb_TmpSignalConversionAtToFile[7] = heli_q8_B.PitchTransferFcn;
    rtb_TmpSignalConversionAtToFile[8] = heli_q8_B.Sum_j;
    rtb_TmpSignalConversionAtToFile[9] = heli_q8_B.ElevationTransferFcn;
    rtb_TmpSignalConversionAtToFile[10] = heli_q8_B.Integrator1;
    rtb_TmpSignalConversionAtToFile[11] = heli_q8_B.Integrator;
  ...
  /* Sum: '<S11>/Sum' */
  heli_q8_B.Sum_h = heli_q8_B.ElevationTransferFcn - heli_q8_B.Sum[1];

  /* Sum: '<S11>/Sum1' */
  heli_q8_B.Sum1_b = heli_q8_B.PitchCounttorad - heli_q8_B.Sum[0];
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.Gain2[2] != 0.0) {
       ...
       */
      if (heli_q8_B.Gain2[2] != 0.0) {
        rtb_Sqrt = heli_q8_B.Gain2[2];
      } else {
        rtb_Sqrt = heli_q8_P.Constant_Value_g;
      }

      /* End of Switch: '<S18>/Switch' */
      heli_q8_B.Switch1 = atan(heli_q8_B.Gain2[1] / rtb_Sqrt);
    } else {
      heli_q8_B.Switch1 = heli_q8_P.Constant1_Value_c;
    }
     ...
     *  Sum: '<S17>/Sum'
     */
    rtb_Sqrt = sqrt(heli_q8_B.Gain2[1] * heli_q8_B.Gain2[1] + heli_q8_B.Gain2[2]
                    * heli_q8_B.Gain2[2]);

    /* Switch: '<S17>/Switch1' incorporates:
     *  Constant: '<S17>/Constant1'
     *  Trigonometry: '<S17>/atan '
     */
    if (rtb_Sqrt != 0.0) {
      ...
      rtb_Sqrt = rt_atan2d_snf(heli_q8_B.Gain2[0], rtb_Sqrt);
    } else {
      rtb_Sqrt = heli_q8_P.Constant1_Value;
    }
     ...
     */
    heli_q8_B.Sum1_p = rtb_Sqrt - heli_q8_P.Constant2_Value;
     ...
     */
    /* MATLAB Function 'Measurement/Gyro vector to [pitch rate, elevation rate, travle rate]': '<S13>:1' */
    /* '<S13>:1:3' */
    /* '<S13>:1:4' */
    /* psi = euler_angles(3); */
    /* '<S13>:1:8' */
    /* '<S13>:1:11' */
    tmp_1[0] = 1.0;
    tmp_1[3] = sin(heli_q8_B.Switch1) * tan(heli_q8_B.Sum1_p);
    tmp_1[6] = cos(heli_q8_B.Switch1) * tan(heli_q8_B.Sum1_p);
    tmp_1[1] = 0.0;
    tmp_1[4] = cos(heli_q8_B.Switch1);
    tmp_1[7] = -sin(heli_q8_B.Switch1);
    tmp_1[2] = 0.0;
    tmp_1[5] = sin(heli_q8_B.Switch1) / cos(heli_q8_B.Sum1_p);
    tmp_1[8] = cos(heli_q8_B.Switch1) / cos(heli_q8_B.Sum1_p);
    for (i = 0; i < 3; i++) {
      heli_q8_B.euler_rates[i] = 0.0;
      heli_q8_B.euler_rates[i] += tmp_1[i] * rtb_Gain1[0];
      heli_q8_B.euler_rates[i] += tmp_1[i + 3] * rtb_Gain1[1];
      heli_q8_B.euler_rates[i] += tmp_1[i + 6] * rtb_Gain1[2];
    }
  ...
  for (i = 0; i < 4; i++) {
    ...
    for (i_0 = 0; i_0 < 7; i_0++) {
       ...
       *  Sum: '<S8>/Sum'
       */
      tmp_2[i] += heli_q8_P.C[(i_0 << 2) + i] * rtb_Gain[i_0];

      /* Gain: '<S8>/Gain1' incorporates:
       *  Sum: '<S8>/Sum'
       */
      tmp_3[i] += heli_q8_P.C[(i_0 << 2) + i] * heli_q8_B.Integrator_a[i_0];
    }
  ...
  for (i = 0; i < 7; i++) {
    ...
    rtb_Gain[i] = 0.0;
    for (i_0 = 0; i_0 < 7; i_0++) {
      rtb_Gain[i] += heli_q8_P.A[7 * i_0 + i] * heli_q8_B.Integrator_a[i_0];
    }
     ...
     */
    tmp_5[i] = 0.0;
    tmp_5[i] += heli_q8_P.L[i] * tmp_4[0];
    tmp_5[i] += heli_q8_P.L[i + 7] * tmp_4[1];
    tmp_5[i] += heli_q8_P.L[i + 14] * tmp_4[2];
    tmp_5[i] += heli_q8_P.L[i + 21] * tmp_4[3];

    /* Sum: '<S8>/Sum1' incorporates:
     *  Gain: '<S8>/Gain3'
     *  SignalConversion: '<S8>/TmpSignal ConversionAtGain3Inport1'
     */
    heli_q8_B.Sum1_e[i] = (heli_q8_P.B[i + 7] * heli_q8_B.Sum_jz[1] +
      heli_q8_P.B[i] * heli_q8_B.Sum1) + (rtb_Gain[i] + tmp_5[i]);
  }
}
...
void heli_q8_derivatives(void)
{
  ...
  _rtXdot->Integrator1_CSTATE = heli_q8_B.Sum1_b;
  ...
  for (i = 0; i < 7; i++) {
    _rtXdot->Integrator_CSTATE_j[i] = heli_q8_B.Sum1_e[i];
  }
...
void heli_q8_initialize(void)
{
  ...
  /* Start for DiscretePulseGenerator: '<S12>/Pulse Generator' */
  heli_q8_DW.clockTickCounter = -2500;

  /* Start for DiscretePulseGenerator: '<S12>/Pulse Generator1' */
  heli_q8_DW.clockTickCounter_e = -2500;
  ...
  /* Start for ToFile: '<S10>/To File' */
  {
    ...
    if (rt_WriteMat4FileHeader(fp,13,0,"data")) {
      rtmSetErrorStatus(heli_q8_M,
...

  {
    ...
    for (i = 0; i < 7; i++) {
      heli_q8_X.Integrator_CSTATE_j[i] = heli_q8_P.Integrator_IC_m;
    }
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<S10>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (rt_WriteMat4FileHeader(fp, 13, heli_q8_DW.ToFile_IWORK.Count, "data"))
      {
        rtmSetErrorStatus(heli_q8_M,
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (4131503199U);
  heli_q8_M->Sizes.checksums[1] = (2835449775U);
  heli_q8_M->Sizes.checksums[2] = (575760999U);
  heli_q8_M->Sizes.checksums[3] = (1618112752U);
...

  {
    ...
    heli_q8_B.Sum_jz[0] = 0.0;
    heli_q8_B.Sum_jz[1] = 0.0;
    heli_q8_B.V_s0 = 0.0;
    heli_q8_B.Sum1 = 0.0;
  ...
  heli_q8_M->Sizes.numBlockPrms = (590);/* Sum of parameter "widths" */
  return heli_q8_M;
}
