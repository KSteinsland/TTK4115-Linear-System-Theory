  ...
  ;%***********************
    ...
    ;%
	  ...
	  section.data(4).dtTransOffset = 91;
	  ...
	  section.data(9).dtTransOffset = 139;
	
	  ;% heli_q8_P.elevation_test
	  section.data(10).logicalSrcIdx = 9;
	  section.data(10).dtTransOffset = 140;
	
	  ;% heli_q8_P.pitch_test
	  section.data(11).logicalSrcIdx = 10;
	  section.data(11).dtTransOffset = 141;
	
	  ;% heli_q8_P.HILInitialize_analog_input_maxi
	  section.data(12).logicalSrcIdx = 11;
	  section.data(12).dtTransOffset = 142;
	
	  ;% heli_q8_P.HILInitialize_analog_input_mini
	  section.data(13).logicalSrcIdx = 12;
	  section.data(13).dtTransOffset = 143;
	
	  ;% heli_q8_P.HILInitialize_analog_output_max
	  section.data(14).logicalSrcIdx = 13;
	  section.data(14).dtTransOffset = 144;
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.Scope10_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 18;
	  section.data(3).dtTransOffset = 4;
	
	  ;% heli_q8_DW.Scope11_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 19;
	  section.data(4).dtTransOffset = 6;
	
	  ;% heli_q8_DW.Scope12_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 20;
	  section.data(5).dtTransOffset = 8;
	
	  ;% heli_q8_DW.Scope2_PWORK_c.LoggedData
	  section.data(6).logicalSrcIdx = 21;
	  section.data(6).dtTransOffset = 10;
	
	  ;% heli_q8_DW.Scope8_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 22;
	  section.data(7).dtTransOffset = 12;
	
	  ;% heli_q8_DW.Scope9_PWORK.LoggedData
  ...
  targMap.checksum0 = 4131503199;
  targMap.checksum1 = 2835449775;
  targMap.checksum2 = 575760999;
  targMap.checksum3 = 1618112752;
