...
typedef struct {
  ...
  real_T PulseGenerator1;              /* '<S12>/Pulse Generator1' */
  real_T Sum[2];                       /* '<S10>/Sum' */
  ...
  real_T Sum1_p;                       /* '<S17>/Sum1' */
  real_T Sum1_e[7];                    /* '<S8>/Sum1' */
...
typedef struct {
  ...
  real_T Memory_PreviousInput[10];     /* '<S3>/Memory' */
  ...
  struct {
    void *LoggedData[2];
  } Scope10_PWORK;                     /* '<S7>/Scope10' */

  struct {
    void *LoggedData[2];
  } Scope11_PWORK;                     /* '<S7>/Scope11' */

  struct {
    void *LoggedData[2];
  } Scope12_PWORK;                     /* '<S7>/Scope12' */

  struct {
    void *LoggedData[2];
  } Scope2_PWORK_c;                    /* '<S7>/Scope2' */

  struct {
    void *LoggedData[2];
  } Scope8_PWORK;                      /* '<S7>/Scope8' */

  struct {
    void *LoggedData[2];
  } Scope9_PWORK;                      /* '<S7>/Scope9' */
  ...
  struct {
    void *LoggedData[3];
  } accelerationscope_PWORK;           /* '<S6>/acceleration scope' */

  struct {
    void *LoggedData[2];
  } eulerelevationrate_PWORK;          /* '<S6>/euler elevation rate' */

  struct {
    void *LoggedData[2];
  } eulerpitchrate_PWORK;              /* '<S6>/euler pitch rate' */

  struct {
    void *LoggedData[2];
  } eulertravelrate_PWORK;             /* '<S6>/euler travel rate' */

  struct {
    void *LoggedData[2];
  } elevationimu_PWORK;                /* '<S16>/elevation imu' */

  struct {
    void *LoggedData[2];
  } pitchimu_PWORK;                    /* '<S16>/pitch imu' */
  ...
  int32_T clockTickCounter_e;          /* '<S12>/Pulse Generator1' */
...
typedef struct {
  ...
  real_T Integrator_CSTATE_j[7];       /* '<S8>/Integrator' */
} X_heli_q8_T;
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_j[7];    /* '<S8>/Integrator' */
} XDis_heli_q8_T;
...
struct P_heli_q8_T_ {
  ...
  real_T elevation_test;               /* Variable: elevation_test
                                        * Referenced by: '<S12>/elevation_test_toggle'
                                        */
  real_T pitch_test;                   /* Variable: pitch_test
                                        * Referenced by: '<S12>/pitch_test_toggle'
                                        */
  ...
  real_T PulseGenerator1_Amp;          /* Expression: 0.25
                                        * Referenced by: '<S12>/Pulse Generator1'
                                        */
 ...
 * '<S3>'   : 'heli_q8/IMU1'
 * '<S4>'   : 'heli_q8/Joystick'
 * '<S5>'   : 'heli_q8/LQR with integrator'
 * '<S6>'   : 'heli_q8/Measurement'
 * '<S7>'   : 'heli_q8/scope'
 * '<S8>'   : 'heli_q8/state estimator'
 * '<S9>'   : 'heli_q8/LQR with integrator/Subsystem'
 * '<S10>'  : 'heli_q8/LQR with integrator/Test'
 * '<S11>'  : 'heli_q8/LQR with integrator/integrator'
 * '<S12>'  : 'heli_q8/LQR with integrator/Test/Refernce test'
 * '<S13>'  : 'heli_q8/Measurement/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S14>'  : 'heli_q8/Measurement/convert acceleration'
 * '<S15>'  : 'heli_q8/Measurement/convert rates1'
 * '<S16>'  : 'heli_q8/Measurement/imu angles'
 * '<S17>'  : 'heli_q8/Measurement/imu angles/elevation_eq'
 * '<S18>'  : 'heli_q8/Measurement/imu angles/pitch_eq'
 */
