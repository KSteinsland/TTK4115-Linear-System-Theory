...
#ifndef RTW_HEADER_heli_q8_2015_day3_h_
#define RTW_HEADER_heli_q8_2015_day3_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_q8_2015_day3_COMMON_INCLUDES_
# define heli_q8_2015_day3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_2015_day3_COMMON_INCLUDES_ */

#include "heli_q8_2015_day3_types.h"
...
#define heli_q8_2015_day3_rtModel      RT_MODEL_heli_q8_2015_day3_T
...
typedef struct {
  ...
  real_T Sum1_e[5];                    /* '<S5>/Sum1' */
  uint8_T StreamCall1_o2;              /* '<S6>/Stream Call1' */
} B_heli_q8_2015_day3_T;
...
typedef struct {
  ...
  real_T Memory_PreviousInput_k;       /* '<S15>/Memory' */
  real_T Memory_PreviousInput_c;       /* '<S16>/Memory' */
  ...
  struct {
    void *FilePtr;
  } ToFile_PWORK;                      /* '<S21>/To File' */

  struct {
    void *LoggedData[3];
  } Scopeelevation_PWORK;              /* '<S24>/Scope elevation' */

  struct {
    void *LoggedData[4];
  } Scopeelevationrate_PWORK;          /* '<S24>/Scope elevation rate' */

  struct {
    void *LoggedData[4];
  } Scopepitch_PWORK;                  /* '<S24>/Scope pitch' */

  struct {
    void *LoggedData[3];
  } Scopepitchrate_PWORK;              /* '<S24>/Scope pitch rate' */

  struct {
    void *LoggedData[3];
  } Scopetravelrate_PWORK;             /* '<S24>/Scope travel rate' */
  ...
  int32_T clockTickCounter_e;          /* '<S25>/Pulse Generator1' */
  uint32_T HILInitialize_POSortedChans[8];/* '<Root>/HIL Initialize' */
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK;                      /* '<S21>/To File' */

  uint8_T StreamCall1_State;           /* '<S6>/Stream Call1' */
} DW_heli_q8_2015_day3_T;

/* Continuous states (auto storage) */
typedef struct {
  real_T Integrator_CSTATE[5];         /* '<S5>/Integrator' */
  real_T Integrator1_CSTATE;           /* '<S23>/Integrator1' */
...
typedef struct {
  ...
  real_T PitchTransferFcn_CSTATE;      /* '<S9>/Pitch: Transfer Fcn' */
  real_T TravelTransferFcn_CSTATE;     /* '<S9>/Travel: Transfer Fcn' */
} XDot_heli_q8_2015_day3_T;

/* State disabled  */
typedef struct {
  boolean_T Integrator_CSTATE[5];      /* '<S5>/Integrator' */
  boolean_T Integrator1_CSTATE;        /* '<S23>/Integrator1' */
...
#define rtB                            heli_q8_2015_day3_B
#define BlockIO                        B_heli_q8_2015_day3_T
#define rtX                            heli_q8_2015_day3_X
#define ContinuousStates               X_heli_q8_2015_day3_T
#define rtXdot                         heli_q8_2015_day3_XDot
#define StateDerivatives               XDot_heli_q8_2015_day3_T
#define tXdis                          heli_q8_2015_day3_XDis
#define StateDisabled                  XDis_heli_q8_2015_day3_T
#define rtP                            heli_q8_2015_day3_P
#define Parameters                     P_heli_q8_2015_day3_T
#define rtDWork                        heli_q8_2015_day3_DW
#define D_Work                         DW_heli_q8_2015_day3_T

/* Parameters (auto storage) */
struct P_heli_q8_2015_day3_T_ {
  ...
  real_T elevation_offset;             /* Variable: elevation_offset
                                        * Referenced by: '<S16>/elevation offset'
                                        */
  real_T elevation_test;               /* Variable: elevation_test
                                        * Referenced by: '<S25>/elevation_test_toggle'
                                        */
  real_T imu_start[5];                 /* Variable: imu_start
  ...
  real_T pitch_test;                   /* Variable: pitch_test
                                        * Referenced by: '<S25>/pitch_test_toggle'
                                        */
  ...
  real_T PulseGenerator1_PhaseDelay;   /* Expression: 5
                                        * Referenced by: '<S25>/Pulse Generator1'
                                        */
  real_T Constant_Value_b;             /* Expression: 0.1
  ...
  real_T Memory_X0_f;                  /* Expression: 0
                                        ...
                                        */
  real_T Memory_X0_fk;                 /* Expression: 0
                                        * Referenced by: '<S15>/Memory'
                                        */
  real_T Constant2_Value;              /* Expression: 0.11
  ...
  real_T Switch_Threshold_i;           /* Expression: 0
                                        ...
                                        */
  real_T Step_Y0_f;                    /* Expression: 1
                                        * Referenced by: '<S15>/Step'
                                        */
  real_T Step_YFinal_b;                /* Expression: 0
                                        * Referenced by: '<S15>/Step'
                                        */
  ...
  real_T ElevationTransferFcn_D;       /* Computed Parameter: ElevationTransferFcn_D
                                        * Referenced by: '<S9>/Elevation: Transfer Fcn'
                                        */
  real_T Constant_Value_f;             /* Expression: 0.53
  ...
  real_T BackmotorSaturation_LowerSat; /* Expression: -5
                                        * Referenced by: '<S8>/Back motor: Saturation'
                                        */
  real_T waitcalibrate1_Y0_o;          /* Expression: 0
                                        * Referenced by: '<S5>/wait calibrate 1'
                                        */
  real_T waitcalibrate1_YFinal_f;      /* Expression: 1
                                        * Referenced by: '<S5>/wait calibrate 1'
                                        */
...
struct tag_RTM_heli_q8_2015_day3_T {
  const char_T *path;
...
extern P_heli_q8_2015_day3_T heli_q8_2015_day3_P;

/* Block signals (auto storage) */
extern B_heli_q8_2015_day3_T heli_q8_2015_day3_B;

/* Continuous states (auto storage) */
extern X_heli_q8_2015_day3_T heli_q8_2015_day3_X;

/* Block states (auto storage) */
extern DW_heli_q8_2015_day3_T heli_q8_2015_day3_DW;
...
extern void heli_q8_2015_day3_initialize(void);
extern void heli_q8_2015_day3_output0(void);
extern void heli_q8_2015_day3_update0(void);
extern void heli_q8_2015_day3_output(int_T tid);
extern void heli_q8_2015_day3_update(int_T tid);
extern void heli_q8_2015_day3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_2015_day3_rtModel *heli_q8_2015_day3(void);
...
extern RT_MODEL_heli_q8_2015_day3_T *const heli_q8_2015_day3_M;
 ...
 *
 * '<Root>' : 'heli_q8_2015_day3'
 * '<S1>'   : 'heli_q8_2015_day3/Conversion'
 * '<S2>'   : 'heli_q8_2015_day3/Heli 3D'
 * '<S3>'   : 'heli_q8_2015_day3/Joystick'
 * '<S4>'   : 'heli_q8_2015_day3/LQR with integrator'
 * '<S5>'   : 'heli_q8_2015_day3/state estimator'
 * '<S6>'   : 'heli_q8_2015_day3/Heli 3D/IMU1'
 * '<S7>'   : 'heli_q8_2015_day3/Heli 3D/Measurement'
 * '<S8>'   : 'heli_q8_2015_day3/Heli 3D/Motor driver'
 * '<S9>'   : 'heli_q8_2015_day3/Heli 3D/Subsystem'
 * '<S10>'  : 'heli_q8_2015_day3/Heli 3D/Measurement/Calibrate'
 * '<S11>'  : 'heli_q8_2015_day3/Heli 3D/Measurement/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S12>'  : 'heli_q8_2015_day3/Heli 3D/Measurement/convert to x'
 * '<S13>'  : 'heli_q8_2015_day3/Heli 3D/Measurement/imu angles'
 * '<S14>'  : 'heli_q8_2015_day3/Heli 3D/Measurement/Calibrate/calibrate'
 * '<S15>'  : 'heli_q8_2015_day3/Heli 3D/Measurement/Calibrate/calibrate1'
 * '<S16>'  : 'heli_q8_2015_day3/Heli 3D/Measurement/Calibrate/calibrate2'
 * '<S17>'  : 'heli_q8_2015_day3/Heli 3D/Measurement/Calibrate/calibrate3'
 * '<S18>'  : 'heli_q8_2015_day3/Heli 3D/Measurement/Calibrate/calibrate5'
 * '<S19>'  : 'heli_q8_2015_day3/Heli 3D/Measurement/imu angles/elevation_eq'
 * '<S20>'  : 'heli_q8_2015_day3/Heli 3D/Measurement/imu angles/pitch_eq'
 * '<S21>'  : 'heli_q8_2015_day3/LQR with integrator/Subsystem'
 * '<S22>'  : 'heli_q8_2015_day3/LQR with integrator/Test'
 * '<S23>'  : 'heli_q8_2015_day3/LQR with integrator/integrator'
 * '<S24>'  : 'heli_q8_2015_day3/LQR with integrator/Subsystem/scope'
 * '<S25>'  : 'heli_q8_2015_day3/LQR with integrator/Test/Refernce test'
 */
#endif                                 /* RTW_HEADER_heli_q8_2015_day3_h_ */
