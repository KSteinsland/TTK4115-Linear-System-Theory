...
void heli_q8_2015_output0(void)        /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_2015_M)) {
     ...
     */
    heli_q8_2015_B.Sum_j = heli_q8_2015_B.ElevationCounttorad -
   ...
   */
  tmp[0] = heli_q8_2015_B.PitchCounttorad;
  tmp[1] = heli_q8_2015_B.PitchTransferFcn;
  tmp[2] = heli_q8_2015_B.Sum_j;
  tmp[3] = heli_q8_2015_B.ElevationTransferFcn;
  tmp[4] = heli_q8_2015_B.TravelTransferFcn;
  tmp[5] = heli_q8_2015_X.Integrator1_CSTATE;
  tmp[6] = heli_q8_2015_X.Integrator_CSTATE;
  for (i = 0; i < 2; i++) {
    /* Gain: '<S4>/Gain1' incorporates:
     *  Sum: '<S4>/Sum'
     */
    tmp_0[i] = 0.0;
    tmp_0[i] += heli_q8_2015_P.F[i] * heli_q8_2015_B.Sum[0];
    tmp_0[i] += heli_q8_2015_P.F[i + 2] * heli_q8_2015_B.Sum[1];
    ...
    /* Sum: '<S4>/Sum' */
    heli_q8_2015_B.Sum_jz[i] = tmp_0[i] - tmp_1[i];
  }
  ...
  /* Sum: '<S4>/Sum1' */
  heli_q8_2015_B.Sum1 = heli_q8_2015_B.Sum_jz[0] + heli_q8_2015_B.V_s0;
  if (rtmIsMajorTimeStep(heli_q8_2015_M)) {
    ...
    /* MATLAB Function: '<S7>/Gyro vector to [pitch rate, elevation rate, travle rate]' */
    for (i = 0; i < 3; i++) {
      heli_q8_2015_B.euler_rates[i] = 0.0;
      heli_q8_2015_B.euler_rates[i] += tmp_2[i] * rtb_Gain2[0];
      heli_q8_2015_B.euler_rates[i] += tmp_2[i + 3] * rtb_Gain2[1];
      heli_q8_2015_B.euler_rates[i] += tmp_2[i + 6] * rtb_Gain2[2];
    }
  }
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_Sqrt = (heli_q8_2015_B.Sum1 - heli_q8_2015_B.Sum_jz[1]) *
  ...
  for (i = 0; i < 5; i++) {
    heli_q8_2015_B.Integrator[i] = heli_q8_2015_X.Integrator_CSTATE_j[i];
  }

  /* End of Integrator: '<S5>/Integrator' */

  /* Bias: '<S5>/imu offset1' */
  heli_q8_2015_B.imuoffset1 = heli_q8_2015_B.Integrator[0] +
  ...
  if (rtmIsMajorTimeStep(heli_q8_2015_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[4] = heli_q8_2015_B.imuoffset1;
    rtb_TmpSignalConversionAtToFile[7] = heli_q8_2015_B.imuoffset;
    rtb_TmpSignalConversionAtToFile[8] = heli_q8_2015_B.Integrator[4];
    rtb_TmpSignalConversionAtToFile[9] = heli_q8_2015_B.Switch1;
    rtb_TmpSignalConversionAtToFile[10] = heli_q8_2015_B.euler_rates[0];
    rtb_TmpSignalConversionAtToFile[11] = heli_q8_2015_B.Sum1_p;
    rtb_TmpSignalConversionAtToFile[0] = heli_q8_2015_B.Sum[0];
    rtb_TmpSignalConversionAtToFile[2] = heli_q8_2015_B.Sum_jz[0];
    rtb_TmpSignalConversionAtToFile[5] = heli_q8_2015_B.Integrator[1];
    rtb_TmpSignalConversionAtToFile[12] = heli_q8_2015_B.euler_rates[1];
    rtb_TmpSignalConversionAtToFile[1] = heli_q8_2015_B.Sum[1];
    rtb_TmpSignalConversionAtToFile[3] = heli_q8_2015_B.Sum_jz[1];
    rtb_TmpSignalConversionAtToFile[6] = heli_q8_2015_B.Integrator[2];
    rtb_TmpSignalConversionAtToFile[13] = heli_q8_2015_B.euler_rates[2];
    rtb_TmpSignalConversionAtToFile[14] = heli_q8_2015_B.PitchCounttorad;
    rtb_TmpSignalConversionAtToFile[15] = heli_q8_2015_B.PitchTransferFcn;
    rtb_TmpSignalConversionAtToFile[16] = heli_q8_2015_B.Sum_j;
    rtb_TmpSignalConversionAtToFile[17] = heli_q8_2015_B.ElevationTransferFcn;
    rtb_TmpSignalConversionAtToFile[18] = heli_q8_2015_B.TravelTransferFcn;

    /* ToFile: '<S15>/To File' */
    if (rtmIsMajorTimeStep(heli_q8_2015_M)) {
      {
        if (!(++heli_q8_2015_DW.ToFile_IWORK.Decimation % 1) &&
            (heli_q8_2015_DW.ToFile_IWORK.Count*20)+1 < 100000000 ) {
          ...
          if (fp != (NULL)) {
            ...
            if (((++heli_q8_2015_DW.ToFile_IWORK.Count)*20)+1 >= 100000000) {
              (void)fprintf(stdout,
    ...
    /* SignalConversion: '<S5>/TmpSignal ConversionAtGain4Inport1' incorporates:
     *  Gain: '<S5>/Gain4'
     */
    tmp_3[0] = heli_q8_2015_B.Switch1;
    tmp_3[1] = heli_q8_2015_B.euler_rates[0];
    tmp_3[2] = heli_q8_2015_B.Sum1_p;
    tmp_3[3] = heli_q8_2015_B.euler_rates[1];
    tmp_3[4] = heli_q8_2015_B.euler_rates[2];

    /* Gain: '<S5>/Gain4' */
    for (i = 0; i < 5; i++) {
      heli_q8_2015_B.Gain4[i] = 0.0;
      for (i_0 = 0; i_0 < 5; i_0++) {
        heli_q8_2015_B.Gain4[i] += heli_q8_2015_P.C[5 * i_0 + i] * tmp_3[i_0];
      }
    }
  }

  /* Sum: '<S17>/Sum' */
  heli_q8_2015_B.Sum_n = heli_q8_2015_B.ElevationTransferFcn -
    heli_q8_2015_B.Sum[1];

  /* Sum: '<S17>/Sum1' */
  heli_q8_2015_B.Sum1_h = heli_q8_2015_B.PitchCounttorad - heli_q8_2015_B.Sum[0];
  for (i = 0; i < 5; i++) {
    ...
    rtb_Sqrt = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      rtb_Sqrt += heli_q8_2015_P.C[5 * i_0 + i] * heli_q8_2015_B.Integrator[i_0];
    }

    tmp_3[i] = heli_q8_2015_B.Gain4[i] - rtb_Sqrt;
    ...
    tmp_4[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_4[i] += heli_q8_2015_P.A[5 * i_0 + i] * heli_q8_2015_B.Integrator[i_0];
    }
  ...
  for (i = 0; i < 5; i++) {
    ...
    tmp_5[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_5[i] += heli_q8_2015_P.L[5 * i_0 + i] * tmp_3[i_0];
    }
     ...
     */
    heli_q8_2015_B.Sum1_e[i] = (heli_q8_2015_P.B[i + 5] * heli_q8_2015_B.Sum_jz
      [1] + heli_q8_2015_P.B[i] * rtb_Sqrt) + (tmp_4[i] + tmp_5[i]);
  }
}
...
void heli_q8_2015_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = heli_q8_2015_B.Sum_n;

  /* Derivatives for Integrator: '<S5>/Integrator' */
  for (i = 0; i < 5; i++) {
    _rtXdot->Integrator_CSTATE_j[i] = heli_q8_2015_B.Sum1_e[i];
  }
...
void heli_q8_2015_initialize(void)
{
...

  {
    ...
    heli_q8_2015_X.Integrator_CSTATE = heli_q8_2015_P.Integrator_IC;
    ...
    for (i = 0; i < 5; i++) {
      heli_q8_2015_X.Integrator_CSTATE_j[i] = heli_q8_2015_P.Integrator_IC_m;
    }
...
void heli_q8_2015_terminate(void)
{
  ...
  /* Terminate for ToFile: '<S15>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (rt_WriteMat4FileHeader(fp, 20, heli_q8_2015_DW.ToFile_IWORK.Count,
           "data")) {
        rtmSetErrorStatus(heli_q8_2015_M,
...
RT_MODEL_heli_q8_2015_T *heli_q8_2015(void)
{
  ...
  /* External mode info */
  heli_q8_2015_M->Sizes.checksums[0] = (4212590686U);
  heli_q8_2015_M->Sizes.checksums[1] = (1723426096U);
  heli_q8_2015_M->Sizes.checksums[2] = (691143377U);
  heli_q8_2015_M->Sizes.checksums[3] = (4290427591U);
...

  {
    ...
    heli_q8_2015_B.Sum_j = 0.0;
    heli_q8_2015_B.ElevationTransferFcn = 0.0;
    heli_q8_2015_B.TravelCounttorad = 0.0;
    heli_q8_2015_B.TravelTransferFcn = 0.0;
    heli_q8_2015_B.Sum_jz[0] = 0.0;
    heli_q8_2015_B.Sum_jz[1] = 0.0;
    ...
    heli_q8_2015_B.imuoffset1 = 0.0;
    heli_q8_2015_B.imuoffset = 0.0;
    heli_q8_2015_B.Sum_n = 0.0;
    heli_q8_2015_B.Sum1_h = 0.0;
    heli_q8_2015_B.euler_rates[0] = 0.0;
    heli_q8_2015_B.euler_rates[1] = 0.0;
    heli_q8_2015_B.euler_rates[2] = 0.0;
  }
  ...
  heli_q8_2015_M->Sizes.numBlocks = (119);/* Number of blocks */
  heli_q8_2015_M->Sizes.numBlockIO = (33);/* Number of block outputs */
  heli_q8_2015_M->Sizes.numBlockPrms = (558);/* Sum of parameter "widths" */
