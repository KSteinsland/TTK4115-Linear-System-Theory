 ...
 * C source code generated on : Sat Nov 07 17:27:09 2020
 *
...
typedef struct {
  ...
  real_T Integrator_CSTATE_j[5];       /* '<S5>/Integrator' */
} X_heli_q8_2015_T;
...
typedef struct {
  ...
  boolean_T Integrator_CSTATE_j[5];    /* '<S5>/Integrator' */
} XDis_heli_q8_2015_T;
