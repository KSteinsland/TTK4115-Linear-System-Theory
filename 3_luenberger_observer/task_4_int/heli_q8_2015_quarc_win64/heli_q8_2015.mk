...
MODEL                = heli_q8_2015
MODULES              = heli_q8_2015_data.c heli_q8_2015_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_2015.mk
...
MODELLIB                  = heli_q8_2015lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_2015_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_2015_quarc_win64
