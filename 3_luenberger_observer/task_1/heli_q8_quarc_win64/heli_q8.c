 ...
 * C source code generated on : Sun Oct 18 11:35:51 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (currentTime < heli_q8_P.Step_Time) {
    ...
    currentTime = heli_q8_P.Step_YFinal;
  }

  /* Sum: '<S7>/Sum' incorporates:
   *  Gain: '<S9>/pitch_test_toggle'
   *  Sum: '<S9>/Sum3'
   */
  heli_q8_B.Sum_k[0] = (currentTime + heli_q8_B.PulseGenerator) *
  ...
  for (i = 0; i < 2; i++) {
     ...
     */
    tmp_0[i] = 0.0;
    tmp_0[i] += heli_q8_P.F[i] * heli_q8_B.Sum_k[0];
    tmp_0[i] += heli_q8_P.F[i + 2] * heli_q8_B.Sum_k[1];
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* SignalConversion: '<S7>/TmpSignal ConversionAtTo FileInport1' */
  ...
  /* Sum: '<S8>/Sum1' */
  heli_q8_B.Sum1 = heli_q8_B.PitchCounttorad - heli_q8_B.Sum_k[0];
}
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2428213074U);
  heli_q8_M->Sizes.checksums[1] = (2552089358U);
  heli_q8_M->Sizes.checksums[2] = (3366012323U);
  heli_q8_M->Sizes.checksums[3] = (1266064513U);
  ...
  heli_q8_M->Sizes.numBlocks = (73);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (27);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (459);/* Sum of parameter "widths" */
  return heli_q8_M;
}
