...
typedef struct {
  ...
  real_T PulseGenerator1;              /* '<S9>/Pulse Generator1' */
  real_T Sum_k[2];                     /* '<S7>/Sum' */
  real_T Sum_j[2];                     /* '<S5>/Sum' */
  real_T Sum_h;                        /* '<S8>/Sum' */
  real_T Sum1;                         /* '<S8>/Sum1' */
...
typedef struct {
  ...
  int32_T clockTickCounter_e;          /* '<S9>/Pulse Generator1' */
...
struct P_heli_q8_T_ {
  ...
  real_T elevation_test;               /* Variable: elevation_test
                                        * Referenced by: '<S9>/elevation_test_toggle'
                                        */
  real_T pitch_test;                   /* Variable: pitch_test
                                        * Referenced by: '<S9>/pitch_test_toggle'
                                        */
 ...
 * '<S7>'   : 'heli_q8/LQR with integrator/Test'
 * '<S8>'   : 'heli_q8/LQR with integrator/integrator'
 * '<S9>'   : 'heli_q8/LQR with integrator/Test/Refernce test'
 * '<S10>'  : 'heli_q8/Measurement/convert acceleration'
 * '<S11>'  : 'heli_q8/Measurement/convert rates'
 */
