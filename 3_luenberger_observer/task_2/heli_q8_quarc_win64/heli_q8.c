 ...
 * C source code generated on : Sat Oct 17 19:53:16 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* S-Function (stream_formatted_write_block): '<S4>/Stream Formatted Write' */
    {
      ...
      if (rtb_StreamCall1_o1 != NULL) {
        result = stream_print_utf8_char_array(*rtb_StreamCall1_o1,
          ...
          "%c\n"
          , (char) heli_q8_P.Constant1_Value_o
          );
        if (result > 0) {
     ...
     */
    rtb_DeadZoney = heli_q8_B.Gain2[1] * heli_q8_B.Gain2[1] + heli_q8_B.Gain2[2]
      * heli_q8_B.Gain2[2];
    ...
    if (rtb_Sqrt != 0.0) {
       ...
       */
      if (!(rtb_Sqrt != 0.0)) {
        rtb_Sqrt = heli_q8_P.Constant_Value_j;
      }

      /* End of Switch: '<S8>/Switch' */
      rtb_DeadZoney = rt_atan2d_snf(heli_q8_B.Gain2[0], rtb_Sqrt);
    } else {
      rtb_DeadZoney = heli_q8_P.Constant1_Value_e;
    }
     ...
     */
    heli_q8_B.Sum1 = rtb_DeadZoney - heli_q8_P.Constant2_Value;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.Gain2[2] != 0.0) {
      ...
      heli_q8_B.Switch1 = heli_q8_P.Constant1_Value;
    }
    ...
    /* '<S2>:1:11' */
    tmp[0] = 1.0;
    tmp[3] = sin(heli_q8_B.Switch1) * tan(heli_q8_B.Sum1);
    tmp[6] = cos(heli_q8_B.Switch1) * tan(heli_q8_B.Sum1);
    tmp[1] = 0.0;
    tmp[4] = cos(heli_q8_B.Switch1);
    tmp[7] = -sin(heli_q8_B.Switch1);
    tmp[2] = 0.0;
    tmp[5] = sin(heli_q8_B.Switch1) / cos(heli_q8_B.Sum1);
    tmp[8] = cos(heli_q8_B.Switch1) / cos(heli_q8_B.Sum1);
    for (i = 0; i < 3; i++) {
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* End of DiscretePulseGenerator: '<S11>/Pulse Generator1' */
  }
   ...
   *  Gain: '<S11>/pitch_test_toggle'
   *  Sum: '<S11>/Sum3'
   */
  heli_q8_B.Sum_k[0] = (rtb_Sqrt + heli_q8_B.PulseGenerator) *
  ...
  /* Sum: '<S9>/Sum' incorporates:
   *  Gain: '<S11>/elevation_test_toggle'
   *  Sum: '<S11>/Sum1'
   */
  heli_q8_B.Sum_k[1] = (currentTime + heli_q8_B.PulseGenerator1) *
  ...
  tmp_0[3] = heli_q8_B.Integrator1;
  tmp_0[4] = heli_q8_B.Integrator;
  for (i = 0; i < 2; i++) {
    /* Gain: '<S6>/Gain1' incorporates:
     *  Sum: '<S6>/Sum'
     */
    tmp_1[i] = 0.0;
    tmp_1[i] += heli_q8_P.F[i] * heli_q8_B.Sum_k[0];
    tmp_1[i] += heli_q8_P.F[i + 2] * heli_q8_B.Sum_k[1];
    ...
    /* Sum: '<S6>/Sum' */
    heli_q8_B.Sum_j[i] = tmp_1[i] - tmp_2[i];
  }

  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* SignalConversion: '<S9>/TmpSignal ConversionAtTo FileInport1' */
    rtb_TmpSignalConversionAtToFile[0] = heli_q8_B.Sum_k[0];
    rtb_TmpSignalConversionAtToFile[2] = heli_q8_B.Sum_j[0];
    rtb_TmpSignalConversionAtToFile[1] = heli_q8_B.Sum_k[1];
    rtb_TmpSignalConversionAtToFile[3] = heli_q8_B.Sum_j[1];
    ...
    rtb_TmpSignalConversionAtToFile[8] = heli_q8_B.Sum;
  ...
  /* Sum: '<S10>/Sum' */
  heli_q8_B.Sum_h = heli_q8_B.ElevationTransferFcn - heli_q8_B.Sum_k[1];

  /* Sum: '<S10>/Sum1' */
  heli_q8_B.Sum1_b = heli_q8_B.PitchCounttorad - heli_q8_B.Sum_k[0];
}
...
void heli_q8_initialize(void)
{
  ...
  /* Start for DiscretePulseGenerator: '<S11>/Pulse Generator' */
  heli_q8_DW.clockTickCounter = -2500;

  /* Start for DiscretePulseGenerator: '<S11>/Pulse Generator1' */
  heli_q8_DW.clockTickCounter_e = -2500;

  /* Start for ToFile: '<S9>/To File' */
  {
    FILE *fp = (NULL);
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<S9>/To File' */
  {
    FILE *fp = (FILE *) heli_q8_DW.ToFile_PWORK.FilePtr;
    if (fp != (NULL)) {
      char fileName[509] = "test.mat";
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (1255104262U);
  heli_q8_M->Sizes.checksums[1] = (886780181U);
  heli_q8_M->Sizes.checksums[2] = (482710124U);
  heli_q8_M->Sizes.checksums[3] = (2616873088U);
...

  {
    ...
    heli_q8_B.Sum_k[0] = 0.0;
    heli_q8_B.Sum_k[1] = 0.0;
    heli_q8_B.Sum_j[0] = 0.0;
    heli_q8_B.Sum_j[1] = 0.0;
    heli_q8_B.Sum_h = 0.0;
  ...
  heli_q8_M->Sizes.numBlocks = (105);  /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (30);  /* Number of block outputs */
  heli_q8_M->Sizes.numBlockPrms = (465);/* Sum of parameter "widths" */
  return heli_q8_M;
}
