...
typedef struct {
  ...
  real_T PulseGenerator;               /* '<S11>/Pulse Generator' */
  real_T PulseGenerator1;              /* '<S11>/Pulse Generator1' */
  real_T Sum_k[2];                     /* '<S9>/Sum' */
...
typedef struct {
  ...
  struct {
    void *LoggedData[2];
  } elevation1_PWORK;                  /* '<Root>/elevation1' */

  struct {
    void *LoggedData[2];
  } elevation_rate_PWORK;              /* '<Root>/elevation_rate' */
  ...
  struct {
    void *LoggedData[2];
  } pitch_rate_PWORK;                  /* '<Root>/pitch_rate' */
  ...
  struct {
    void *LoggedData[2];
  } travel_rate_PWORK;                 /* '<Root>/travel_rate' */
  ...
  int32_T clockTickCounter_e;          /* '<S11>/Pulse Generator1' */
  uint32_T HILInitialize_POSortedChans[8];/* '<Root>/HIL Initialize' */
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK;                      /* '<S9>/To File' */
...
struct P_heli_q8_T_ {
  ...
  real_T elevation_test;               /* Variable: elevation_test
                                        * Referenced by: '<S11>/elevation_test_toggle'
                                        */
  real_T pitch_test;                   /* Variable: pitch_test
                                        * Referenced by: '<S11>/pitch_test_toggle'
                                        */
  ...
  real_T Constant_Value_b;             /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_o;            /* Expression: 65
 ...
 * '<S4>'   : 'heli_q8/IMU'
 * '<S5>'   : 'heli_q8/Joystick'
 * '<S6>'   : 'heli_q8/LQR with integrator'
 * '<S7>'   : 'heli_q8/pitch_eq'
 * '<S8>'   : 'heli_q8/pitch_eq1'
 * '<S9>'   : 'heli_q8/LQR with integrator/Test'
 * '<S10>'  : 'heli_q8/LQR with integrator/integrator'
 * '<S11>'  : 'heli_q8/LQR with integrator/Test/Refernce test'
 */
