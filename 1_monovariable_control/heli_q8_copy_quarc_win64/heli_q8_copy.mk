...
MODEL                = heli_q8_copy
MODULES              = heli_q8_copy_data.c heli_q8_copy_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_copy.mk
...
MODELLIB                  = heli_q8_copylib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_copy_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_copy_quarc_win64
