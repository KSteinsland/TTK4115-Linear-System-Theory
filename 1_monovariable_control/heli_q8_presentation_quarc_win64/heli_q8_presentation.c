 ...
 * C source code generated on : Mon Aug 31 17:24:07 2020
 *
...
void heli_q8_presentation_output0(void) /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_presentation_M)) {
    ...
    /* S-Function Block: heli_q8_presentation/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      t_error result;
    ...
    if (heli_q8_presentation_B.RateTransitionx >
      ...
      rtb_Sum_p = heli_q8_presentation_B.RateTransitionx -
        heli_q8_presentation_P.DeadZonex_End;
    ...
    heli_q8_presentation_B.Joystick_gain_x = heli_q8_presentation_P.Gainx_Gain *
      rtb_Sum_p * heli_q8_presentation_P.Joystick_gain_x;
     ...
     *  Sum: '<S5>/Sum'
     */
    heli_q8_presentation_B.K_pp = (heli_q8_presentation_P.Gain_Gain *
      heli_q8_presentation_B.Joystick_gain_x -
      heli_q8_presentation_B.PitchCounttorad) * heli_q8_presentation_P.K_pp;
  }
   ...
   *  Sum: '<S5>/Sum1'
   */
  rtb_Frontgain = (heli_q8_presentation_B.K_pp - heli_q8_presentation_P.K_pd *
                   heli_q8_presentation_B.PitchTransferFcn) *
    heli_q8_presentation_P.Gain_Gain_n;

  /* Integrator: '<S6>/Integrator' */
  /* Limited  Integrator  */
  if (heli_q8_presentation_X.Integrator_CSTATE >=
      heli_q8_presentation_P.Integrator_UpperSat) {
    heli_q8_presentation_X.Integrator_CSTATE =
      heli_q8_presentation_P.Integrator_UpperSat;
  } else {
    if (heli_q8_presentation_X.Integrator_CSTATE <=
  ...
  if (rtmIsMajorTimeStep(heli_q8_presentation_M)) {
     ...
     */
    heli_q8_presentation_B.Sum = heli_q8_presentation_B.ElevationCounttorad -
    ...
    if (heli_q8_presentation_B.RateTransitiony >
      ...
      rtb_Backgain = heli_q8_presentation_B.RateTransitiony -
        heli_q8_presentation_P.DeadZoney_End;
    ...
    heli_q8_presentation_B.Joystick_gain_y = heli_q8_presentation_P.Gainy_Gain *
      rtb_Backgain * heli_q8_presentation_P.Joystick_gain_y;

    /* Sum: '<S2>/Sum' incorporates:
     *  Gain: '<Root>/Gain1'
     */
    rtb_Sum_p = heli_q8_presentation_P.Gain1_Gain *
      heli_q8_presentation_B.Joystick_gain_y - heli_q8_presentation_B.Sum;

    /* Gain: '<S6>/K_ep' */
    heli_q8_presentation_B.K_ep = heli_q8_presentation_P.K_ep_Gain * rtb_Sum_p;

    /* Constant: '<Root>/V_s0' */
    heli_q8_presentation_B.V_s0 = heli_q8_presentation_P.V_s0_Value;
  }
   ...
   *  Sum: '<S6>/Sum'
   */
  rtb_Backgain = ((heli_q8_presentation_X.Integrator_CSTATE +
  ...
  if (rtmIsMajorTimeStep(heli_q8_presentation_M)) {
    /* Gain: '<S6>/K_ei' */
    heli_q8_presentation_B.K_ei = heli_q8_presentation_P.K_ei_Gain * rtb_Sum_p;
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_Sum_p = (rtb_Backgain - rtb_Frontgain) *
    heli_q8_presentation_P.Frontgain_Gain;

  /* Saturate: '<S3>/Front motor: Saturation' */
  if (rtb_Sum_p > heli_q8_presentation_P.FrontmotorSaturation_UpperSat) {
    heli_q8_presentation_B.FrontmotorSaturation =
      heli_q8_presentation_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_Sum_p < heli_q8_presentation_P.FrontmotorSaturation_LowerSat) {
    heli_q8_presentation_B.FrontmotorSaturation =
      heli_q8_presentation_P.FrontmotorSaturation_LowerSat;
  } else {
    heli_q8_presentation_B.FrontmotorSaturation = rtb_Sum_p;
  }
  ...
  if (rtb_Sum_p > heli_q8_presentation_P.BackmotorSaturation_UpperSat) {
    heli_q8_presentation_B.BackmotorSaturation =
      heli_q8_presentation_P.BackmotorSaturation_UpperSat;
  } else if (rtb_Sum_p < heli_q8_presentation_P.BackmotorSaturation_LowerSat) {
    heli_q8_presentation_B.BackmotorSaturation =
      heli_q8_presentation_P.BackmotorSaturation_LowerSat;
  } else {
    heli_q8_presentation_B.BackmotorSaturation = rtb_Sum_p;
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_presentation_M)) {
    ...
    /* S-Function Block: heli_q8_presentation/Heli 3D/HIL Write Analog (hil_write_analog_block) */
    {
      t_error result;
...
void heli_q8_presentation_derivatives(void)
{
  ...
  lsat = (heli_q8_presentation_X.Integrator_CSTATE <=
          heli_q8_presentation_P.Integrator_LowerSat);
  usat = (heli_q8_presentation_X.Integrator_CSTATE >=
          heli_q8_presentation_P.Integrator_UpperSat);
  if (((!lsat) && (!usat)) || (lsat && (heli_q8_presentation_B.K_ei > 0.0)) ||
      (usat && (heli_q8_presentation_B.K_ei < 0.0))) {
    _rtXdot->Integrator_CSTATE = heli_q8_presentation_B.K_ei;
  } else {
    /* in saturation */
...
RT_MODEL_heli_q8_presentation_T *heli_q8_presentation(void)
{
  ...
  heli_q8_presentation_P.Integrator_UpperSat = rtInf;
  heli_q8_presentation_P.Integrator_LowerSat = rtMinusInf;
  ...
  /* External mode info */
  heli_q8_presentation_M->Sizes.checksums[0] = (2544079027U);
  heli_q8_presentation_M->Sizes.checksums[1] = (2879732723U);
  heli_q8_presentation_M->Sizes.checksums[2] = (1956639505U);
  heli_q8_presentation_M->Sizes.checksums[3] = (3700847408U);
  ...
  /* Initialize Sizes */
  heli_q8_presentation_M->Sizes.numContStates = (4);/* Number of continuous states */
  ...
  heli_q8_presentation_M->Sizes.numBlocks = (49);/* Number of blocks */
  heli_q8_presentation_M->Sizes.numBlockIO = (19);/* Number of block outputs */
  heli_q8_presentation_M->Sizes.numBlockPrms = (148);/* Sum of parameter "widths" */
