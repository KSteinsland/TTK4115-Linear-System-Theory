...
struct P_heli_q8_presentation_T_ {
  ...
  real_T K_ed_Gain;                    /* Expression: 12
                                        ...
                                        */
  real_T V_s0_Value;                   /* Expression: 7.5
 ...
 * '<S2>'   : 'heli_q8_presentation/Elevation controller'
 * '<S3>'   : 'heli_q8_presentation/Heli 3D'
 * '<S4>'   : 'heli_q8_presentation/Joystick'
 * '<S5>'   : 'heli_q8_presentation/Pitch controller'
 * '<S6>'   : 'heli_q8_presentation/Elevation controller/Elevation controller'
 */
