...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Scopeelevation_PWORK;              /* '<S7>/Scope elevation' */

  struct {
    void *LoggedData[2];
  } Scopeelevationrate_PWORK;          /* '<S7>/Scope elevation rate' */

  struct {
    void *LoggedData[2];
  } Scopepitch_PWORK;                  /* '<S7>/Scope pitch' */

  struct {
    void *LoggedData;
  } Scopepitchrate_PWORK;              /* '<S7>/Scope pitch rate' */

  struct {
    void *LoggedData;
  } Scopetravel_PWORK;                 /* '<S7>/Scope travel' */

  struct {
    void *LoggedData;
  } Scopetravelrate_PWORK;             /* '<S7>/Scope travel rate' */

  struct {
    void *LoggedData;
  } ScopeV_d_PWORK;                    /* '<S7>/Scope V_d' */

  struct {
    void *LoggedData;
  } ScopeV_s_PWORK;                    /* '<S7>/Scope V_s' */

  struct {
    void *LoggedData;
  } Scopegamma_PWORK;                  /* '<S7>/Scope gamma' */

  struct {
    void *LoggedData;
  } Scopezeta_PWORK;                   /* '<S7>/Scope zeta' */
  ...
  int32_T clockTickCounter_d;          /* '<S8>/Pulse Generator1' */
 ...
 * '<S2>'   : 'heli_q8/Heli 3D'
 * '<S3>'   : 'heli_q8/Joystick'
 * '<S4>'   : 'heli_q8/Measurement'
 * '<S5>'   : 'heli_q8/Test1'
 * '<S6>'   : 'heli_q8/controller'
 * '<S7>'   : 'heli_q8/Measurement/scope'
 * '<S8>'   : 'heli_q8/Test1/Refernce test'
 */
