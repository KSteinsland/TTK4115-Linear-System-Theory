 ...
 * C source code generated on : Sat Nov 07 23:57:35 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    if (heli_q8_B.RateTransitionx > heli_q8_P.DeadZonex_End) {
      rtb_PulseGenerator1 = heli_q8_B.RateTransitionx - heli_q8_P.DeadZonex_End;
    } else if (heli_q8_B.RateTransitionx >= heli_q8_P.DeadZonex_Start) {
      rtb_PulseGenerator1 = 0.0;
    } else {
      rtb_PulseGenerator1 = heli_q8_B.RateTransitionx -
     ...
     *  Gain: '<S3>/Gain: x'
     */
    heli_q8_B.Joystick_gain_x = heli_q8_P.Gainx_Gain * rtb_PulseGenerator1 *
    ...
    if (heli_q8_B.RateTransitiony > heli_q8_P.DeadZoney_End) {
      rtb_PulseGenerator1 = heli_q8_B.RateTransitiony - heli_q8_P.DeadZoney_End;
    } else if (heli_q8_B.RateTransitiony >= heli_q8_P.DeadZoney_Start) {
      rtb_PulseGenerator1 = 0.0;
    } else {
      rtb_PulseGenerator1 = heli_q8_B.RateTransitiony -
     ...
     *  Gain: '<S3>/Gain: y'
     */
    heli_q8_B.Joystick_gain_y = heli_q8_P.Gainy_Gain * rtb_PulseGenerator1 *
    ...
    rtb_PulseGenerator1 = (heli_q8_DW.clockTickCounter_d <
      heli_q8_P.PulseGenerator1_Duty) && (heli_q8_DW.clockTickCounter_d >= 0) ?
     ...
     */
    heli_q8_B.Sum1 = rtb_PulseGenerator1 - heli_q8_P.Constant_Value;
  }
  ...
  if (heli_q8_M->Timing.t[0] < heli_q8_P.Step_Time) {
    rtb_PulseGenerator1 = heli_q8_P.Step_Y0;
  } else {
    rtb_PulseGenerator1 = heli_q8_P.Step_YFinal;
  }
   ...
   *  Sum: '<S8>/Sum3'
   */
  heli_q8_B.Sum[0] = (rtb_PulseGenerator1 + heli_q8_B.PulseGenerator) *
  ...
  /* Step: '<S8>/Step2' */
  if (currentTime < 5.0 * heli_q8_P.calibrate_time) {
   ...
   *  Sum: '<S8>/Sum2'
   */
  heli_q8_B.Sum[1] = (currentTime + heli_q8_B.Sum1) * rtb_Backgain *
  ...
  for (i = 0; i < 2; i++) {
     ...
     */
    heli_q8_B.Sum_j[i] = (heli_q8_P.F[i + 2] * heli_q8_B.Sum[1] + heli_q8_P.F[i]
                          * heli_q8_B.Sum[0]) - (heli_q8_P.K[i + 4] *
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum_jp = heli_q8_B.ElevationCounttorad -
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[2] = heli_q8_B.Sum_j[1];
    rtb_TmpSignalConversionAtToFile[3] = heli_q8_B.Sum_j[0];
    rtb_TmpSignalConversionAtToFile[4] = heli_q8_B.PitchCounttorad;
    rtb_TmpSignalConversionAtToFile[5] = heli_q8_B.PitchTransferFcn;
    rtb_TmpSignalConversionAtToFile[6] = heli_q8_B.Sum_jp;
    rtb_TmpSignalConversionAtToFile[7] = heli_q8_B.ElevationTransferFcn;
    rtb_TmpSignalConversionAtToFile[8] = heli_q8_B.TravelCounttorad;
    rtb_TmpSignalConversionAtToFile[9] = heli_q8_B.TravelTransferFcn;
...
void heli_q8_initialize(void)
{
  ...
  heli_q8_DW.clockTickCounter_d = -2500;
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<S4>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (rt_WriteMat4FileHeader(fp, 11, heli_q8_DW.ToFile_IWORK.Count, "data"))
      {
        rtmSetErrorStatus(heli_q8_M,
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (2119926222U);
  heli_q8_M->Sizes.checksums[1] = (1521356442U);
  heli_q8_M->Sizes.checksums[2] = (3581160798U);
  heli_q8_M->Sizes.checksums[3] = (2700874937U);
