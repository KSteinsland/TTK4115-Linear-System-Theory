  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.Scopeelevation_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_DW.Scopeelevationrate_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_DW.Scopepitch_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 17;
	  section.data(4).dtTransOffset = 4;
	
	  ;% heli_q8_DW.Scopepitchrate_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 18;
	  section.data(5).dtTransOffset = 6;
	
	  ;% heli_q8_DW.Scopetravel_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 19;
	  section.data(6).dtTransOffset = 7;
	
	  ;% heli_q8_DW.Scopetravelrate_PWORK.LoggedData
	  section.data(7).logicalSrcIdx = 20;
	  section.data(7).dtTransOffset = 8;
	
	  ;% heli_q8_DW.ScopeV_d_PWORK.LoggedData
	  section.data(8).logicalSrcIdx = 21;
	  section.data(8).dtTransOffset = 9;
	
	  ;% heli_q8_DW.ScopeV_s_PWORK.LoggedData
	  section.data(9).logicalSrcIdx = 22;
	  section.data(9).dtTransOffset = 10;
	
	  ;% heli_q8_DW.Scopegamma_PWORK.LoggedData
	  section.data(10).logicalSrcIdx = 23;
	  section.data(10).dtTransOffset = 11;
	
	  ;% heli_q8_DW.Scopezeta_PWORK.LoggedData
  ...
  targMap.checksum0 = 2119926222;
  targMap.checksum1 = 1521356442;
  targMap.checksum2 = 3581160798;
  targMap.checksum3 = 2700874937;
