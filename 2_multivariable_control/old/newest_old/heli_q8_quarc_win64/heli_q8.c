 ...
 * C source code generated on : Fri Oct 02 18:32:25 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Gain1_j[0] = 0.0;
    heli_q8_B.Gain1_j[0] += heli_q8_P.F[0] * rtb_Gain;
    heli_q8_B.Gain1_j[0] += heli_q8_P.F[2] * heli_q8_B.Gain1;
    heli_q8_B.Gain1_j[1] = 0.0;
    heli_q8_B.Gain1_j[1] += heli_q8_P.F[1] * rtb_Gain;
    heli_q8_B.Gain1_j[1] += heli_q8_P.F[3] * heli_q8_B.Gain1;
  }
  ...
  for (i = 0; i < 2; i++) {
    ...
    rtb_Sum[i] = heli_q8_B.Gain1_j[i] - rtb_Backgain;
  }
  ...
  /* Sum: '<Root>/Sum' */
  rtb_Backgain = rtb_Sum[0] + heli_q8_B.V_s0;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (rtb_Backgain - rtb_Sum[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (rtb_Backgain + rtb_Sum[1]) * heli_q8_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Sum: '<S5>/Sum1' */
    heli_q8_B.Sum1 = heli_q8_B.PitchCounttorad - rtb_Gain;
  }

  /* Sum: '<S5>/Sum' */
  heli_q8_B.Sum_h = heli_q8_B.ElevationTransferFcn - heli_q8_B.Gain1;
}
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3845699782U);
  heli_q8_M->Sizes.checksums[1] = (1573192753U);
  heli_q8_M->Sizes.checksums[2] = (3869922357U);
  heli_q8_M->Sizes.checksums[3] = (2542826595U);
