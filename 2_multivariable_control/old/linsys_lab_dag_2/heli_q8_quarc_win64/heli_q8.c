 ...
 * C source code generated on : Mon Sep 21 13:16:55 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  /* Sum: '<Root>/Sum3' */
  heli_q8_B.Sum3 = rtb_Sum1 + heli_q8_B.PulseGenerator;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  ...
  rtb_VectorConcatenate1[0] = heli_q8_B.PitchCounttorad;
  ...
  rtb_VectorConcatenate1[1] = heli_q8_B.PitchTransferFcn;
  ...
  rtb_VectorConcatenate1[2] = heli_q8_B.ElevationTransferFcn;

  /* Integrator: '<S4>/Integrator' */
  rtb_VectorConcatenate1[3] = heli_q8_X.Integrator_CSTATE;

  /* Integrator: '<S4>/Integrator1' */
  rtb_VectorConcatenate1[4] = heli_q8_X.Integrator1_CSTATE;
  ...
  /* Sum: '<Root>/Sum1' */
  rtb_Sum1 = heli_q8_B.Sum3 + heli_q8_B.Gain;
  for (i = 0; i < 2; i++) {
     ...
     */
    tmp[i] = 0.0;
    tmp[i] += heli_q8_P.F[i] * rtb_Sum1;
    tmp[i] += heli_q8_P.F[i + 2] * heli_q8_B.Gain1;
    ...
    tmp_0[i] = 0.0;
    for (i_0 = 0; i_0 < 5; i_0++) {
      tmp_0[i] += heli_q8_P.K[(i_0 << 1) + i] * rtb_VectorConcatenate1[i_0];
    }

    /* End of Gain: '<S4>/Gain' */

    /* Sum: '<S4>/Sum' */
    heli_q8_B.Sum[i] = tmp[i] - tmp_0[i];
  }
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     */
    heli_q8_B.Sum_j = heli_q8_B.ElevationCounttorad - heli_q8_P.Constant_Value;

    /* SignalConversion: '<Root>/TmpSignal ConversionAtTo FileInport1' */
    rtb_TmpSignalConversionAtToFile[0] = heli_q8_B.Sum3;
    rtb_TmpSignalConversionAtToFile[1] = heli_q8_B.Sum[1];
    rtb_TmpSignalConversionAtToFile[2] = heli_q8_B.Sum[0];
    rtb_TmpSignalConversionAtToFile[3] = heli_q8_B.TravelCounttorad;
    rtb_TmpSignalConversionAtToFile[4] = heli_q8_B.TravelTransferFcn;
    rtb_TmpSignalConversionAtToFile[5] = heli_q8_B.PitchCounttorad;
    rtb_TmpSignalConversionAtToFile[6] = heli_q8_B.PitchTransferFcn;
    rtb_TmpSignalConversionAtToFile[7] = heli_q8_B.Sum_j;
  ...
  /* Sum: '<Root>/Sum' */
  heli_q8_B.Sum_m = heli_q8_B.Sum[0] + heli_q8_B.V_s0;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  u0 = (heli_q8_B.Sum_m - heli_q8_B.Sum[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  u0 = (heli_q8_B.Sum_m + heli_q8_B.Sum[1]) * heli_q8_P.Backgain_Gain;
  ...
  /* Sum: '<S4>/Sum1' */
  heli_q8_B.Sum1 = heli_q8_B.ElevationTransferFcn - heli_q8_B.Gain1;

  /* Sum: '<S4>/Sum2' */
  heli_q8_B.Sum2 = heli_q8_B.PitchCounttorad - rtb_Sum1;
}
...
void heli_q8_terminate(void)
{
  ...
  /* Terminate for ToFile: '<Root>/To File' */
  {
    ...
    if (fp != (NULL)) {
      ...
      if (rt_WriteMat4FileHeader(fp, 10, heli_q8_DW.ToFile_IWORK.Count, "data"))
      {
        rtmSetErrorStatus(heli_q8_M,
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3414647150U);
  heli_q8_M->Sizes.checksums[1] = (1337952385U);
  heli_q8_M->Sizes.checksums[2] = (455114640U);
  heli_q8_M->Sizes.checksums[3] = (3210685825U);
