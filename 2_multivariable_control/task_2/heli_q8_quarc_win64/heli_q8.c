 ...
 * C source code generated on : Sun Oct 11 18:47:07 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
    ...
    /* S-Function Block: heli_q8/Heli 3D/HIL Read Encoder Timebase (hil_read_encoder_timebase_block) */
    {
      ...
      if (result < 0) {
        ...
        rtb_HILReadEncoderTimebase_o1 =
          heli_q8_DW.HILReadEncoderTimebase_Buffer[0];
        rtb_Gain1 = heli_q8_DW.HILReadEncoderTimebase_Buffer[1];
        rtb_Gain = heli_q8_DW.HILReadEncoderTimebase_Buffer[2];
      }
    }

    /* Gain: '<S3>/Pitch: Count to rad' */
    heli_q8_B.PitchCounttorad = heli_q8_P.PitchCounttorad_Gain * rtb_Gain1;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  SignalConversion: '<S1>/TmpSignal ConversionAtGain1Inport1'
     */
    heli_q8_B.Gain1[0] = 0.0;
    heli_q8_B.Gain1[0] += heli_q8_P.F[0] * rtb_Gain;
    heli_q8_B.Gain1[0] += heli_q8_P.F[2] * rtb_Gain1;
    heli_q8_B.Gain1[1] = 0.0;
    heli_q8_B.Gain1[1] += heli_q8_P.F[1] * rtb_Gain;
    heli_q8_B.Gain1[1] += heli_q8_P.F[3] * rtb_Gain1;
  }
   ...
   */
  for (i = 0; i < 2; i++) {
    rtb_Sum[i] = heli_q8_B.Gain1[i] - ((heli_q8_P.K[i + 2] *
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (622732946U);
  heli_q8_M->Sizes.checksums[1] = (3407518809U);
  heli_q8_M->Sizes.checksums[2] = (2349935467U);
  heli_q8_M->Sizes.checksums[3] = (1155472143U);
