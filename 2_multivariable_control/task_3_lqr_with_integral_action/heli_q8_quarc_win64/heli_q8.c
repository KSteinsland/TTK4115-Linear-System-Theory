 ...
 * C source code generated on : Sat Oct 17 16:15:39 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
   ...
   *  Gain: '<S7>/pitch_test_toggle'
   *  Sum: '<S7>/Sum3'
   */
  heli_q8_B.Sum[0] = (rtb_Backgain + heli_q8_B.PulseGenerator) *
  ...
  tmp[3] = heli_q8_B.Integrator1;
  tmp[4] = heli_q8_B.Integrator;
  for (i = 0; i < 2; i++) {
    /* Gain: '<S4>/Gain1' incorporates:
     *  Sum: '<S4>/Sum'
     */
    tmp_0[i] = 0.0;
    tmp_0[i] += heli_q8_P.F[i] * heli_q8_B.Sum[0];
    tmp_0[i] += heli_q8_P.F[i + 2] * heli_q8_B.Sum[1];
    ...
    /* Sum: '<S4>/Sum' */
    heli_q8_B.Sum_j[i] = tmp_0[i] - tmp_1[i];
  }
  ...
  /* Sum: '<S4>/Sum1' */
  rtb_Backgain = heli_q8_B.Sum_j[0] + heli_q8_B.V_s0;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    /* Sum: '<S2>/Sum' incorporates:
     *  Constant: '<S2>/Constant'
     */
    heli_q8_B.Sum_jp = heli_q8_B.ElevationCounttorad - heli_q8_P.Constant_Value;
   ...
   *  Sum: '<S1>/Add'
   */
  currentTime = (rtb_Backgain - heli_q8_B.Sum_j[1]) * heli_q8_P.Frontgain_Gain;
   ...
   *  Sum: '<S1>/Subtract'
   */
  currentTime = (rtb_Backgain + heli_q8_B.Sum_j[1]) * heli_q8_P.Backgain_Gain;
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    rtb_TmpSignalConversionAtToFile[8] = heli_q8_B.Sum_jp;
  ...
  /* Sum: '<S6>/Sum1' */
  heli_q8_B.Sum1 = heli_q8_B.PitchCounttorad - heli_q8_B.Sum[0];
}
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3338829096U);
  heli_q8_M->Sizes.checksums[1] = (3576326666U);
  heli_q8_M->Sizes.checksums[2] = (1998865942U);
  heli_q8_M->Sizes.checksums[3] = (163653544U);
