...
typedef struct {
  ...
  real_T PulseGenerator1;              /* '<S7>/Pulse Generator1' */
  real_T Sum[2];                       /* '<S5>/Sum' */
...
typedef struct {
  ...
  int32_T clockTickCounter_e;          /* '<S7>/Pulse Generator1' */
...
struct P_heli_q8_T_ {
  ...
  real_T elevation_test;               /* Variable: elevation_test
                                        * Referenced by: '<S7>/elevation_test_toggle'
                                        */
  real_T pitch_test;                   /* Variable: pitch_test
                                        * Referenced by: '<S7>/pitch_test_toggle'
                                        */
 ...
 * '<S2>'   : 'heli_q8/Heli 3D'
 * '<S3>'   : 'heli_q8/Joystick'
 * '<S4>'   : 'heli_q8/LQR with integrator'
 * '<S5>'   : 'heli_q8/LQR with integrator/Test'
 * '<S6>'   : 'heli_q8/LQR with integrator/integrator'
 * '<S7>'   : 'heli_q8/LQR with integrator/Test/Refernce test'
 */
