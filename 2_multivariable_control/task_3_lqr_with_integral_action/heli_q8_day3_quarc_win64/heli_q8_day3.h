...
#ifndef RTW_HEADER_heli_q8_day3_h_
#define RTW_HEADER_heli_q8_day3_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_q8_day3_COMMON_INCLUDES_
# define heli_q8_day3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_day3_COMMON_INCLUDES_ */

#include "heli_q8_day3_types.h"
...
#define heli_q8_day3_rtModel           RT_MODEL_heli_q8_day3_T
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } Scopeelevation_PWORK;              /* '<S9>/Scope elevation' */

  struct {
    void *LoggedData[2];
  } Scopeelevationrate_PWORK;          /* '<S9>/Scope elevation rate' */

  struct {
    void *LoggedData[2];
  } Scopepitch_PWORK;                  /* '<S9>/Scope pitch' */

  struct {
    void *LoggedData;
  } Scopepitchrate_PWORK;              /* '<S9>/Scope pitch rate' */

  struct {
    void *LoggedData;
  } Scopetravel_PWORK;                 /* '<S9>/Scope travel' */

  struct {
    void *LoggedData;
  } Scopetravelrate_PWORK;             /* '<S9>/Scope travel rate' */

  struct {
    void *LoggedData;
  } ScopeV_d_PWORK;                    /* '<S9>/Scope V_d' */

  struct {
    void *LoggedData;
  } ScopeV_s_PWORK;                    /* '<S9>/Scope V_s' */

  struct {
    void *LoggedData;
  } Scopegamma_PWORK;                  /* '<S9>/Scope gamma' */

  struct {
    void *LoggedData;
  } Scopezeta_PWORK;                   /* '<S9>/Scope zeta' */
...
#define rtB                            heli_q8_day3_B
#define BlockIO                        B_heli_q8_day3_T
#define rtX                            heli_q8_day3_X
#define ContinuousStates               X_heli_q8_day3_T
#define rtXdot                         heli_q8_day3_XDot
#define StateDerivatives               XDot_heli_q8_day3_T
#define tXdis                          heli_q8_day3_XDis
#define StateDisabled                  XDis_heli_q8_day3_T
#define rtP                            heli_q8_day3_P
#define Parameters                     P_heli_q8_day3_T
#define rtDWork                        heli_q8_day3_DW
#define D_Work                         DW_heli_q8_day3_T

/* Parameters (auto storage) */
struct P_heli_q8_day3_T_ {
  ...
  real_T elevation_test;               /* Variable: elevation_test
                                        * Referenced by: '<S8>/elevation_test_toggle'
                                        */
  real_T pitch_test;                   /* Variable: pitch_test
                                        * Referenced by: '<S8>/pitch_test_toggle'
                                        */
  ...
  real_T Gainy_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T SineWaveFunction_Amp;         /* Expression: 0.25
                                        * Referenced by: '<S8>/Sine Wave Function'
                                        */
  ...
  real_T SineWaveFunction_Phase;       /* Expression: 0
                                        * Referenced by: '<S8>/Sine Wave Function'
                                        */
  real_T SineWaveFunction1_Amp;        /* Expression: 0.25
                                        * Referenced by: '<S8>/Sine Wave Function1'
                                        */
  ...
  real_T SineWaveFunction1_Freq;       /* Expression: 1
                                        * Referenced by: '<S8>/Sine Wave Function1'
                                        */
  real_T SineWaveFunction1_Phase;      /* Expression: 1.571
                                        * Referenced by: '<S8>/Sine Wave Function1'
                                        */
...
extern P_heli_q8_day3_T heli_q8_day3_P;

/* Block signals (auto storage) */
extern B_heli_q8_day3_T heli_q8_day3_B;

/* Continuous states (auto storage) */
extern X_heli_q8_day3_T heli_q8_day3_X;

/* Block states (auto storage) */
extern DW_heli_q8_day3_T heli_q8_day3_DW;
...
extern void heli_q8_day3_initialize(void);
extern void heli_q8_day3_output0(void);
extern void heli_q8_day3_update0(void);
extern void heli_q8_day3_output(int_T tid);
extern void heli_q8_day3_update(int_T tid);
extern void heli_q8_day3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_day3_rtModel *heli_q8_day3(void);
...
extern RT_MODEL_heli_q8_day3_T *const heli_q8_day3_M;
 ...
 *
 * '<Root>' : 'heli_q8_day3'
 * '<S1>'   : 'heli_q8_day3/Conversion'
 * '<S2>'   : 'heli_q8_day3/Heli 3D'
 * '<S3>'   : 'heli_q8_day3/Joystick'
 * '<S4>'   : 'heli_q8_day3/LQR with integrator'
 * '<S5>'   : 'heli_q8_day3/Measurement'
 * '<S6>'   : 'heli_q8_day3/LQR with integrator/Test'
 * '<S7>'   : 'heli_q8_day3/LQR with integrator/integrator'
 * '<S8>'   : 'heli_q8_day3/LQR with integrator/Test/Refernce test'
 * '<S9>'   : 'heli_q8_day3/Measurement/scope'
 */
#endif                                 /* RTW_HEADER_heli_q8_day3_h_ */
