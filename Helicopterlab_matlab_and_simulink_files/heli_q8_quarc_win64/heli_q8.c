 ...
 * C source code generated on : Mon Aug 31 10:01:03 2020
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
    ...
    /* Gain: '<Root>/Gain1' */
    rtb_FrontmotorSaturation = heli_q8_P.Gain1_Gain * heli_q8_B.Joystick_gain_y;
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (4066315833U);
  heli_q8_M->Sizes.checksums[1] = (3502913198U);
  heli_q8_M->Sizes.checksums[2] = (9693344U);
  heli_q8_M->Sizes.checksums[3] = (1434908261U);
  ...
  heli_q8_M->Sizes.numBlocks = (38);   /* Number of blocks */
  heli_q8_M->Sizes.numBlockIO = (13);  /* Number of block outputs */
